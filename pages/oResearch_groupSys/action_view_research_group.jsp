	...
	<table cellpadding=0 cellspacing=0>
		<tr>
			<td><jsp:include page="/pages/common/templates/groupHeader.jsp">
				<jsp:param name="HeaderKey" value="research/spgroup/spdata" />
			</jsp:include></td>
		</tr>
		<tr align="center">
					...
					<td align="center"><nested:nest property="research_group_Form">
						...
						<table cellpadding=0 cellspacing=0>
							...
							<tr>
								...
								<td class="FormFieldRight"><nested:write property="unit" />
							...
							<tr>
								...
								<td class="FormFieldRight"><nested:textarea
									property="description" readonly="true" /></td>
							</tr>
							<tr>
								<td class="FormSeparator"></td>
								<td class="BlankSeparator"></td>
							...
							<tr>
								...
								<td class="FormFieldRight"><nested:write property="group" />
