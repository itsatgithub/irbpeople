	...
	<table cellpadding=0 cellspacing=0>
		<tr>
			<td><jsp:include page="/pages/common/templates/groupHeader.jsp">
				<jsp:param name="HeaderKey" value="research_group.modify" />
			</jsp:include></td>
		</tr>
		<tr align="center">
					...
					<td align="center"><nested:nest property="research_group_Form">
						...
						<table cellpadding=0 cellspacing=0>
							...
							<tr>
								...
								<td class="FormFieldRight"><script type="text/javascript">
var changed=false;
function isConfirmed(){
	if(changed) return true;
	var result=confirm('<bean:message key="supervisor_changed_confirmation" />');
	if(result) changed=true;
	return result;
}
</script> <nested-jim:TagSelectionPopUp property="supervisor"
									codeProperty="personalcode"
