...
<tr><td style="border:1px solid black; background:#ffffff; padding:10px" ><bean:message key="funding_details_info"/></td></tr>
</table>
<br>
...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectfield" value="oPersonalSys__action_manage_my_rgroup_personal_funding_details"/>
