...
<jsp:include page="/pages/common/lists/filter.jsp" flush="true">
	<jsp:param name="reportfield" value="oPersonalSys__action_manage_my_rgroup_personal_professionals"/>
</jsp:include>
...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectfield" value="oPersonalSys__action_manage_my_rgroup_personal_professionals"/>
