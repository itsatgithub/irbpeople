...
<jsp:include page="/pages/common/lists/filter.jsp" flush="true">
	<jsp:param name="reportfield" value="oUser_accessSys__action_manage_user_access"/>
</jsp:include>
</td></tr>
<tr><td>
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	<jsp:param name="selectionType" value="ROWACTION"/>
	<jsp:param name="objectname" value="user_access"/>
	<jsp:param name="objectfield" value="oUser_accessSys__action_manage_user_access"/>
