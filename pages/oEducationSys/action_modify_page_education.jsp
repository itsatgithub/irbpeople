...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="education.modify"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<nested-jim:TagSelect property="type.type_of_educationcode"   required="true" required="true">
...
<nested:text property="title" maxlength="100" size="50"/>
