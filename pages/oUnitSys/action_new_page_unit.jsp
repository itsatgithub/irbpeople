...
<html:form action="<%=JspUtils.getCurrentAction(request)%>">
	...
	<nested:nest property="unit_Form">
		<nested:hidden property="unitcode" />
	</nested:nest>
	...
	<table cellpadding=0 cellspacing=0>
		<tr>
			<td><jsp:include page="/pages/common/templates/groupHeader.jsp">
				<jsp:param name="HeaderKey" value="unit.new" />
			</jsp:include></td>
		</tr>
		<tr align="center">
			...
			<table class="FormTable" cellpadding=0 cellspacing=0>
				...
				<tr>
					<td align="center"><nested:nest property="unit_Form">
						...
						<table cellpadding=0 cellspacing=0>
							...
							<tr>
								...
								<td class="FormFieldLeft"><jim:message
									key="organization/spunit" /> *</td>
								<td class="FormFieldRight"><nested-jim:TagSelect
									property="organization_unit.organization_unitcode"
									required="true">
									<nested-jim:TagOptionsCollection
										name="_selec_organization_unit" label="_descripcion"
										value="organization_unitcode" />
							...
							<tr>
								...
								*</td>
								<td class="FormFieldRight"><nested:text
									property="description" maxlength="100" /></td>
							</tr>
							<tr>
								<td class="FormSeparator"></td>
								<td class="BlankSeparator"></td>
							...
							<tr>
								...
								<td class="FormFieldRight"><nested:text
									property="group" maxlength="100" /></td>
							</tr>
							<tr>
								<td class="FormSeparator"></td>
								<td class="BlankSeparator"></td>
