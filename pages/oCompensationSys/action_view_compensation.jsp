...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="compensation.view"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<jim:message key="compensation/sppersonal" />
	
</td>
<td class="FormFieldRight">
	<nested:write property="compensation_personal"/>
...
<td class="FormFieldRight">
	<nested:write property="type_of_compensation"/>
