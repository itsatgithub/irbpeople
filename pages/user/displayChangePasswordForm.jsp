			...
			<table class="FormTable" cellpadding=0 cellspacing=0>
				<tr>
					<td class="FormFieldLeft"><jim:message
						key="usuario.usuariocode" /></td>
					<td class="FormFieldRight"><bean:write
						name="changePasswordForm" property="usuariocode" /> <html:hidden
						name="changePasswordForm" property="usuariocode" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="FormFieldRight"><html:password
						name="changePasswordForm" property="password" styleClass="Form" />
					</td>
				</tr>
				<tr>
					<td class="FormSeparator"></td>
				...
				<tr>
					...
					<td class="FormFieldRight"><html:password
						name="changePasswordForm" property="password2" styleClass="Form" />
					</td>
				</tr>
			</table>
			</td>
