...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_job_position_types.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_job_position_types_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_alumni_job_position_typescode the new code
		 */
		
		public void setAlumni_job_position_typescode(String alumni_alumni_job_position_typescode){
			
			getAlumni_job_position_types_Form().setAlumni_job_position_typescode(alumni_alumni_job_position_typescode);
		}
