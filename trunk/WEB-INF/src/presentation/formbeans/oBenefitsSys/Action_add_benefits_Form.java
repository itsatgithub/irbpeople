...
/**
 * This class is a FormBeanContainer for the action action_add_benefits.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_benefits_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setBenefits_Form(Benefits_Form benefits_Form){
			...
			/**
			 * Shortcut to the personal code of the Benefit
			 * @return the code of the personal of the Benefit
			 */
			public String getPersonalcode(){
				return getBenefits_Form().getBenefits_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getBenefits_Form().getBenefits_personal().setPersonalcode(personalcode);
			}
