...
/**
 * This class is a FormBeanContainer for the action action_add_academic_info.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_academic_info_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		/**
		 * @return returns the code of the current academic_info_Form (a shortcut of getAcademic_info_Form().getAcademic_infocode())
		 */
		...
		/**
		 * Sets the code of the current academic_info_Form (a shortcut of getAcademic_info_Form().setAcademic_infocode(String))
		 * @param academic_infocode the new code
		 */
		 ...
		 * @param academic_info_Form the new academic_info_Form
		 */
		...
		public void setAcademic_info_Form(Academic_info_Form academic_info_Form){
			...
			/**
			 * Shortcut to the personal code of the Academic_info
			 * @return the code of the personal of the Academic_info
			 */
			public String getPersonalcode(){
				return getAcademic_info_Form().getAcademic_info_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getAcademic_info_Form().getAcademic_info_personal().setPersonalcode(personalcode);
			}
