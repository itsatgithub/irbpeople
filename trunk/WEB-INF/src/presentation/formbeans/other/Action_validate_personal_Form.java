 ...
 */
public class Action_validate_personal_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setPersonal_Form(Personal_Form personal_Form){
			...
			public String getValidationcode() {
				...
				return getPersonal_Form().getValidationCode();
			}
			...
			public void setValidationcode(String validationcode){
				...
				getPersonal_Form().setValidationCode(validationcode);
			}
