...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_communications.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_communications_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_alumni_communicationscode the new code
		 */
		
		public void setAlumni_communicationscode(String alumni_alumni_communicationscode){
			
			getAlumni_communications_Form().setAlumni_communicationscode(alumni_alumni_communicationscode);
		}
