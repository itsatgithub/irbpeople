...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_titles.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_titles_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_alumni_titlescode the new code
		 */
		
		public void setAlumni_titlescode(String alumni_alumni_titlescode){
			
			getAlumni_titles_Form().setAlumni_titlescode(alumni_alumni_titlescode);
		}
