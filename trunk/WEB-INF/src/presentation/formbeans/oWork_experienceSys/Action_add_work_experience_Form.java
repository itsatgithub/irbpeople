...
/**
 * This class is a FormBeanContainer for the action action_add_work_experience.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_work_experience_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setWork_experience_Form(Work_experience_Form work_experience_Form){
			...
			/**
			 * Shortcut to the personal code of the work experience
			 * @return the code of the personal of the work experience
			 */
			public String getPersonalcode(){
				return getWork_experience_Form().getWork_experience_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getWork_experience_Form().getWork_experience_personal().setPersonalcode(personalcode);
			}
