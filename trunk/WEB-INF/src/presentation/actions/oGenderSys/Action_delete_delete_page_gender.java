 ...
 *
 */
public class Action_delete_delete_page_gender extends Action {
...
Action_delete_delete_page_gender_Form action_delete_delete_page_gender_Form=(Action_delete_delete_page_gender_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_gender_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveGender(usercode,action_delete_delete_page_gender_Form.getGendercode());	
