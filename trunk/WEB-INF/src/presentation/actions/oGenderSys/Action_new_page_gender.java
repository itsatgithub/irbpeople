 ...
 *
 */
public class Action_new_page_gender extends Action {
...
Action_new_page_gender_Form action_new_page_gender_Form=(Action_new_page_gender_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_gender_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_gender_Form.class);
	...
	fbManager.setAttribute(gender, "gender_Form", Gender_Form.class, action_new_page_gender_Form.getGender_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oGenderSys__action_new_page_gender_Form", fbManager.getContainer());
