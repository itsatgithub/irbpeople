...
import presentation.formbeans.oProfessionalSys.Action_modify_page_professional_Form;
 ...
 *
 */
public class Action_modify_page_professional extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_modify_page_professional_Form action_modify_page_professional_Form = (Action_modify_page_professional_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_modify_page_professional_Form);

		/** 4.  We obtain the initial POJO. */

		Professional professional = UseCaseFacade.ObtainProfessional(usercode, action_modify_page_professional_Form.getProfessionalcode());
		...
		fbManager = new FormBeanManager(request, Action_modify_page_professional_Form.class);

		/** 6.2.  We add the current POJO merged with the nested-pojo-form-bean to the manager. */

		fbManager.setAttribute(professional, "professional_Form", Professional_Form.class, action_modify_page_professional_Form.getProfessional_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oProfessionalSys__action_modify_page_professional_Form", fbManager.getContainer());
