...
public class ViewAllUsuarios extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
	    ...
	    //use case execution       	        	
	    Pair<Integer,List<Usuario>> usuarios = UseCaseFacade.ObtenerUsuariosActivos(usercode , filter.obtainListConfigurator(locale, true));
    	//write data
