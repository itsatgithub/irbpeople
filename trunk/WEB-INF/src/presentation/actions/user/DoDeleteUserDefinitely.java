...
public class DoDeleteUserDefinitely extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
    	...
    	//Use case execution
        Usuario usuario = UseCaseFacade.BorrarUsuarioDefinitivamente(usercode, usuarioForm.getUsuariocode());
    	...
    	messages.add("info.borrar-usuario-def", new ActionMessage("info.borrar-usuario-def"));
    	errors.add(messages);
