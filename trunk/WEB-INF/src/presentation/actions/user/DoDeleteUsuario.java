...
public class DoDeleteUsuario extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
    	...
    	//Use case execution
        Usuario usuario = UseCaseFacade.BorrarUsuario(usercode, usuarioForm.getUsuariocode());
    	...
    	messages.add("info.borrar-usuario", new ActionMessage("info.borrar-usuario"));
    	errors.add(messages);
