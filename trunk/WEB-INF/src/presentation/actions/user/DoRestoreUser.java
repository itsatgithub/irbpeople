...
public class DoRestoreUser extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
    	...
    	//Use case execution
        Usuario usuario = UseCaseFacade.RestaurarUsuario(usercode, usuarioForm.getUsuariocode());
    	...
    	messages.add("info.restaurar-usuario", new ActionMessage("info.restaurar-usuario"));
    	errors.add(messages);
