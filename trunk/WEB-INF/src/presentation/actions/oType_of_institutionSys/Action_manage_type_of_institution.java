 ...
 *
 */
public class Action_manage_type_of_institution extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_institution>> _list_type_of_institution=UseCaseFacade.ObtainAllType_of_institution(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_institution_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_institution.getSecond(), locale, Type_of_institution_Form.class);
