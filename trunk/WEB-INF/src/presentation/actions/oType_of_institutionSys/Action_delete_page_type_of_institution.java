 ...
 *
 */
public class Action_delete_page_type_of_institution extends Action {
...
Action_delete_page_type_of_institution_Form action_delete_page_type_of_institution_Form=(Action_delete_page_type_of_institution_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_type_of_institution_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_institution type_of_institution = UseCaseFacade.ObtainType_of_institution(usercode, action_delete_page_type_of_institution_Form.getType_of_institutioncode());
...
fbManager=new FormBeanManager(request, Action_delete_page_type_of_institution_Form.class);
	...
	fbManager.setAttribute(type_of_institution, "type_of_institution_Form", Type_of_institution_Form.class, action_delete_page_type_of_institution_Form.getType_of_institution_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_institutionSys__action_delete_page_type_of_institution_Form", fbManager.getContainer());
