 ...
 *
 */
public class Action_manage_marital_status extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Marital_status>> _list_marital_status=UseCaseFacade.ObtainAllMarital_status(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Marital_status_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_marital_status.getSecond(), locale, Marital_status_Form.class);
