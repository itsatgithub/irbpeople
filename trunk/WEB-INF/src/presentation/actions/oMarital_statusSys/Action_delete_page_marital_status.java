 ...
 *
 */
public class Action_delete_page_marital_status extends Action {
...
Action_delete_page_marital_status_Form action_delete_page_marital_status_Form=(Action_delete_page_marital_status_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_marital_status_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Marital_status marital_status = UseCaseFacade.ObtainMarital_status(usercode, action_delete_page_marital_status_Form.getMarital_statuscode());
...
fbManager=new FormBeanManager(request, Action_delete_page_marital_status_Form.class);
	...
	fbManager.setAttribute(marital_status, "marital_status_Form", Marital_status_Form.class, action_delete_page_marital_status_Form.getMarital_status_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oMarital_statusSys__action_delete_page_marital_status_Form", fbManager.getContainer());
