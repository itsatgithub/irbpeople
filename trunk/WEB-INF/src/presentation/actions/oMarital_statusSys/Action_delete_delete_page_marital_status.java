 ...
 *
 */
public class Action_delete_delete_page_marital_status extends Action {
...
Action_delete_delete_page_marital_status_Form action_delete_delete_page_marital_status_Form=(Action_delete_delete_page_marital_status_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_marital_status_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveMarital_status(usercode,action_delete_delete_page_marital_status_Form.getMarital_statuscode());	
