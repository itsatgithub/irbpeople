 ...
 *
 */
public class Action_viewlist_report extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Report>> _list_report=UseCaseFacade.ObtainAllReport(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Report_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_report.getSecond(), locale, Report_Form.class);
