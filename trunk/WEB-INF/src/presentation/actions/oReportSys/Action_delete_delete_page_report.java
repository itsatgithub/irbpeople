 ...
 *
 */
public class Action_delete_delete_page_report extends Action {
...
Action_delete_delete_page_report_Form action_delete_delete_page_report_Form=(Action_delete_delete_page_report_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_report_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveReport(usercode,action_delete_delete_page_report_Form.getReportcode());	
