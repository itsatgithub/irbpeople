 ...
 *
 */
public class Action_delete_delete_page_type_of_benefit extends Action {
...
Action_delete_delete_page_type_of_benefit_Form action_delete_delete_page_type_of_benefit_Form=(Action_delete_delete_page_type_of_benefit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_type_of_benefit_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveType_of_benefit(usercode,action_delete_delete_page_type_of_benefit_Form.getType_of_benefitcode());	
