 ...
 *
 */
public class Action_new_page_type_of_benefit extends Action {
...
Action_new_page_type_of_benefit_Form action_new_page_type_of_benefit_Form=(Action_new_page_type_of_benefit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_benefit_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_benefit type_of_benefit = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_benefit_Form.class);
	...
	fbManager.setAttribute(type_of_benefit, "type_of_benefit_Form", Type_of_benefit_Form.class, action_new_page_type_of_benefit_Form.getType_of_benefit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_benefitSys__action_new_page_type_of_benefit_Form", fbManager.getContainer());
