 ...
 *
 */
public class Action_view_type_of_benefit extends Action {
...
Action_view_type_of_benefit_Form action_view_type_of_benefit_Form=(Action_view_type_of_benefit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_type_of_benefit_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_benefit type_of_benefit = UseCaseFacade.ObtainType_of_benefit(usercode, action_view_type_of_benefit_Form.getType_of_benefitcode());
...
fbManager=new FormBeanManager(request, Action_view_type_of_benefit_Form.class);
	...
	fbManager.setAttribute(type_of_benefit, "type_of_benefit_Form", Type_of_benefit_Form.class, action_view_type_of_benefit_Form.getType_of_benefit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_benefitSys__action_view_type_of_benefit_Form", fbManager.getContainer());
