 ...
 *
 */
public class Action_manage_type_of_education extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_education>> _list_type_of_education=UseCaseFacade.ObtainAllType_of_education(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_education_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_education.getSecond(), locale, Type_of_education_Form.class);
