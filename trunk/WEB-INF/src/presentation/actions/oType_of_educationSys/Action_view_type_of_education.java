 ...
 *
 */
public class Action_view_type_of_education extends Action {
...
Action_view_type_of_education_Form action_view_type_of_education_Form=(Action_view_type_of_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_type_of_education_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_education type_of_education = UseCaseFacade.ObtainType_of_education(usercode, action_view_type_of_education_Form.getType_of_educationcode());
...
fbManager=new FormBeanManager(request, Action_view_type_of_education_Form.class);
	...
	fbManager.setAttribute(type_of_education, "type_of_education_Form", Type_of_education_Form.class, action_view_type_of_education_Form.getType_of_education_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_educationSys__action_view_type_of_education_Form", fbManager.getContainer());
