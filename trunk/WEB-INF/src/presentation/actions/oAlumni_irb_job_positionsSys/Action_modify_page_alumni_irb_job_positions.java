 ...
 *
 */
public class Action_modify_page_alumni_irb_job_positions extends Action {
...
Action_modify_page_alumni_irb_job_positions_Form action_modify_page_alumni_irb_job_positions_Form=(Action_modify_page_alumni_irb_job_positions_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_alumni_irb_job_positions_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_irb_job_positions alumni_irb_job_positions = UseCaseFacade.ObtainAlumni_irb_job_positions(usercode, action_modify_page_alumni_irb_job_positions_Form.getAlumni_irb_job_positionscode());
...
fbManager=new FormBeanManager(request, Action_modify_page_alumni_irb_job_positions_Form.class);
	...
	fbManager.setAttribute(alumni_irb_job_positions, "alumni_irb_job_positions_Form", Alumni_irb_job_positions_Form.class, action_modify_page_alumni_irb_job_positions_Form.getAlumni_irb_job_positions_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_irb_job_positionsSys__action_modify_page_alumni_irb_job_positions_Form", fbManager.getContainer());
