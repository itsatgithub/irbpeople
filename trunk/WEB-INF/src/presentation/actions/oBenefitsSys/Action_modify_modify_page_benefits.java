 ...
 *
 */
public class Action_modify_modify_page_benefits extends Action {
...
Action_modify_modify_page_benefits_Form action_modify_modify_page_benefits_Form=(Action_modify_modify_page_benefits_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_benefits_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Benefits benefits = UseCaseFacade.UpdateBenefits(usercode,(Benefits) fbManager.getPOJO("benefits_Form",Benefits.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "benefitscode="+benefits.getBenefitscode(), isPopUp, benefits.getCode(), benefits.toString());
