 ...
 *
 */
public class Action_viewlist_benefits extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Benefits>> _list_benefits=UseCaseFacade.ObtainAllBenefits(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Benefits_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_benefits.getSecond(), locale, Benefits_Form.class);
