 ...
 *
 */
public class Action_new_new_page_benefits extends Action {
...
Action_new_new_page_benefits_Form action_new_new_page_benefits_Form=(Action_new_new_page_benefits_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_benefits_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Benefits benefits = UseCaseFacade.CreateBenefits(usercode,(Benefits) fbManager.getPOJO("benefits_Form",Benefits.class));	
