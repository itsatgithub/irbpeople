 ...
 *
 */
public class Action_new_new_page_organization_unit extends Action {
...
Action_new_new_page_organization_unit_Form action_new_new_page_organization_unit_Form=(Action_new_new_page_organization_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_organization_unit_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Organization_unit organization_unit = UseCaseFacade.CreateOrganization_unit(usercode,(Organization_unit) fbManager.getPOJO("organization_unit_Form",Organization_unit.class));	
