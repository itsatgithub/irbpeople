 ...
 *
 */
public class Action_new_page_organization_unit extends Action {
...
Action_new_page_organization_unit_Form action_new_page_organization_unit_Form=(Action_new_page_organization_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_organization_unit_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Organization_unit organization_unit = null;
...
fbManager=new FormBeanManager(request, Action_new_page_organization_unit_Form.class);
	...
	fbManager.setAttribute(organization_unit, "organization_unit_Form", Organization_unit_Form.class, action_new_page_organization_unit_Form.getOrganization_unit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oOrganization_unitSys__action_new_page_organization_unit_Form", fbManager.getContainer());
