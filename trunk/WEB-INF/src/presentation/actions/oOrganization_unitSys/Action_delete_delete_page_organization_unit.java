 ...
 *
 */
public class Action_delete_delete_page_organization_unit extends Action {
...
Action_delete_delete_page_organization_unit_Form action_delete_delete_page_organization_unit_Form=(Action_delete_delete_page_organization_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_organization_unit_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveOrganization_unit(usercode,action_delete_delete_page_organization_unit_Form.getOrganization_unitcode());	
