 ...
 *
 */
public class Action_new_new_page_alumni_external_job_positions extends Action {
...
Action_new_new_page_alumni_external_job_positions_Form action_new_new_page_alumni_external_job_positions_Form=(Action_new_new_page_alumni_external_job_positions_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_alumni_external_job_positions_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Alumni_external_job_positions alumni_external_job_positions = UseCaseFacade.CreateAlumni_external_job_positions(usercode,(Alumni_external_job_positions) fbManager.getPOJO("alumni_external_job_positions_Form",Alumni_external_job_positions.class));	
