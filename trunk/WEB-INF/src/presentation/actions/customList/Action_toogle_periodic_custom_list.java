...
public class Action_toogle_periodic_custom_list  extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		UseCaseFacade.SetPeriodicCustomList(usercode, action_load_customList_Form.getCustomListcode());
