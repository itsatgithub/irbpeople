 ...
 *
 */
public class Action_new_new_page_education extends Action {
...
Action_new_new_page_education_Form action_new_new_page_education_Form=(Action_new_new_page_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_education_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Education education = UseCaseFacade.CreateEducation(usercode,(Education) fbManager.getPOJO("education_Form",Education.class));	
