 ...
 *
 */
public class Action_viewlist_education extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Education>> _list_education=UseCaseFacade.ObtainAllEducation(usercode,filter.obtainListConfigurator(locale, false));
