 ...
 *
 */
public class Action_delete_delete_page_education extends Action {
...
Action_delete_delete_page_education_Form action_delete_delete_page_education_Form=(Action_delete_delete_page_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_education_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveEducation(usercode,action_delete_delete_page_education_Form.getEducationcode());	
