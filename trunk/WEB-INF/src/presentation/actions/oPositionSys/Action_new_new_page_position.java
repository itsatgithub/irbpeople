 ...
 *
 */
public class Action_new_new_page_position extends Action {
...
Action_new_new_page_position_Form action_new_new_page_position_Form=(Action_new_new_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_position_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Position position = UseCaseFacade.CreatePosition(usercode,(Position) fbManager.getPOJO("position_Form",Position.class));	
