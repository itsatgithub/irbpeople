 ...
 *
 */
public class Action_delete_delete_page_position extends Action {
...
Action_delete_delete_page_position_Form action_delete_delete_page_position_Form=(Action_delete_delete_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_position_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemovePosition(usercode,action_delete_delete_page_position_Form.getPositioncode());	
