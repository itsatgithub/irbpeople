 ...
 *
 */
public class Action_delete_page_nationality extends Action {
...
Action_delete_page_nationality_Form action_delete_page_nationality_Form=(Action_delete_page_nationality_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_nationality_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Nationality nationality = UseCaseFacade.ObtainNationality(usercode, action_delete_page_nationality_Form.getNationalitycode());
...
fbManager=new FormBeanManager(request, Action_delete_page_nationality_Form.class);
	...
	fbManager.setAttribute(nationality, "nationality_Form", Nationality_Form.class, action_delete_page_nationality_Form.getNationality_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oNationalitySys__action_delete_page_nationality_Form", fbManager.getContainer());
