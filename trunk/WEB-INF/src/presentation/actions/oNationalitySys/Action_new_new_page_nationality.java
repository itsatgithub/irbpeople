 ...
 *
 */
public class Action_new_new_page_nationality extends Action {
...
Action_new_new_page_nationality_Form action_new_new_page_nationality_Form=(Action_new_new_page_nationality_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_nationality_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Nationality nationality = UseCaseFacade.CreateNationality(usercode,(Nationality) fbManager.getPOJO("nationality_Form",Nationality.class));	
