 ...
 *
 */
public class Action_new_page_type_of_study extends Action {
...
Action_new_page_type_of_study_Form action_new_page_type_of_study_Form=(Action_new_page_type_of_study_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_study_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_study type_of_study = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_study_Form.class);
	...
	fbManager.setAttribute(type_of_study, "type_of_study_Form", Type_of_study_Form.class, action_new_page_type_of_study_Form.getType_of_study_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_studySys__action_new_page_type_of_study_Form", fbManager.getContainer());
