 ...
 *
 */
public class Action_view_type_of_study extends Action {
...
Action_view_type_of_study_Form action_view_type_of_study_Form=(Action_view_type_of_study_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_type_of_study_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_study type_of_study = UseCaseFacade.ObtainType_of_study(usercode, action_view_type_of_study_Form.getType_of_studycode());
...
fbManager=new FormBeanManager(request, Action_view_type_of_study_Form.class);
	...
	fbManager.setAttribute(type_of_study, "type_of_study_Form", Type_of_study_Form.class, action_view_type_of_study_Form.getType_of_study_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_studySys__action_view_type_of_study_Form", fbManager.getContainer());
