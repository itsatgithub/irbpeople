 ...
 *
 */
public class Action_delete_delete_page_type_of_study extends Action {
...
Action_delete_delete_page_type_of_study_Form action_delete_delete_page_type_of_study_Form=(Action_delete_delete_page_type_of_study_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_type_of_study_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveType_of_study(usercode,action_delete_delete_page_type_of_study_Form.getType_of_studycode());	
