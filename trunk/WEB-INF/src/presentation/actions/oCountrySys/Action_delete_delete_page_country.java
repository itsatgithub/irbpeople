 ...
 *
 */
public class Action_delete_delete_page_country extends Action {
...
Action_delete_delete_page_country_Form action_delete_delete_page_country_Form=(Action_delete_delete_page_country_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_country_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveCountry(usercode,action_delete_delete_page_country_Form.getCountrycode());	
