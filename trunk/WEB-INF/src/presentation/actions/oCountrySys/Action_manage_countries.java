 ...
 *
 */
public class Action_manage_countries extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Country>> _list_country=UseCaseFacade.ObtainAllCountry(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Country_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_country.getSecond(), locale, Country_Form.class);
