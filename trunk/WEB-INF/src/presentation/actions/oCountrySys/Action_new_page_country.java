 ...
 *
 */
public class Action_new_page_country extends Action {
...
Action_new_page_country_Form action_new_page_country_Form=(Action_new_page_country_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_country_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_country_Form.class);
	...
	fbManager.setAttribute(country, "country_Form", Country_Form.class, action_new_page_country_Form.getCountry_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oCountrySys__action_new_page_country_Form", fbManager.getContainer());
