 ...
 *
 */
public class Action_manage_irb_budget extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Irb_budget>> _list_irb_budget=UseCaseFacade.ObtainAllIrb_budget(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Irb_budget_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_irb_budget.getSecond(), locale, Irb_budget_Form.class);
