 ...
 *
 */
public class Action_new_page_irb_budget extends Action {
...
Action_new_page_irb_budget_Form action_new_page_irb_budget_Form=(Action_new_page_irb_budget_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_irb_budget_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Irb_budget irb_budget = null;
...
fbManager=new FormBeanManager(request, Action_new_page_irb_budget_Form.class);
	...
	fbManager.setAttribute(irb_budget, "irb_budget_Form", Irb_budget_Form.class, action_new_page_irb_budget_Form.getIrb_budget_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oIrb_budgetSys__action_new_page_irb_budget_Form", fbManager.getContainer());
