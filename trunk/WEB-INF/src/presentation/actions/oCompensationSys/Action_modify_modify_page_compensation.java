 ...
 *
 */
public class Action_modify_modify_page_compensation extends Action {
...
Action_modify_modify_page_compensation_Form action_modify_modify_page_compensation_Form=(Action_modify_modify_page_compensation_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_compensation_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Compensation compensation = UseCaseFacade.UpdateCompensation(usercode,(Compensation) fbManager.getPOJO("compensation_Form",Compensation.class));	
