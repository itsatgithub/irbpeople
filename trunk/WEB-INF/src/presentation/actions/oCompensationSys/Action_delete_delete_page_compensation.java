 ...
 *
 */
public class Action_delete_delete_page_compensation extends Action {
...
Action_delete_delete_page_compensation_Form action_delete_delete_page_compensation_Form=(Action_delete_delete_page_compensation_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_compensation_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveCompensation(usercode,action_delete_delete_page_compensation_Form.getCompensationcode());	
