 ...
 *
 */
public class Action_new_new_page_funding_detail extends Action {
...
Action_new_new_page_funding_detail_Form action_new_new_page_funding_detail_Form=(Action_new_new_page_funding_detail_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_funding_detail_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Funding_detail funding_detail = UseCaseFacade.CreateFunding_detail(usercode,(Funding_detail) fbManager.getPOJO("funding_detail_Form",Funding_detail.class));	
