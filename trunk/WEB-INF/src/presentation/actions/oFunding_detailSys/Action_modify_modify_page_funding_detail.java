 ...
 *
 */
public class Action_modify_modify_page_funding_detail extends Action {
...
Action_modify_modify_page_funding_detail_Form action_modify_modify_page_funding_detail_Form=(Action_modify_modify_page_funding_detail_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_funding_detail_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Funding_detail funding_detail = UseCaseFacade.UpdateFunding_detail(usercode,(Funding_detail) fbManager.getPOJO("funding_detail_Form",Funding_detail.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "funding_detailcode="+funding_detail.getFunding_detailcode(), isPopUp, funding_detail.getCode(), funding_detail.toString());
