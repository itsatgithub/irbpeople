 ...
 *
 */
public class Action_modify_modify_page_alumni_external_job_sectors extends Action {
...
Action_modify_modify_page_alumni_external_job_sectors_Form action_modify_modify_page_alumni_external_job_sectors_Form=(Action_modify_modify_page_alumni_external_job_sectors_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_alumni_external_job_sectors_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Alumni_external_job_sectors alumni_external_job_sectors = UseCaseFacade.UpdateAlumni_external_job_sectors(usercode,(Alumni_external_job_sectors) fbManager.getPOJO("alumni_external_job_sectors_Form",Alumni_external_job_sectors.class));	
