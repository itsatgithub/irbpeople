 ...
 *
 */
public class Action_manage_alumni_external_job_sectors extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Alumni_external_job_sectors>> _list_alumni_external_job_sectors=UseCaseFacade.ObtainAllAlumni_external_job_sectors(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Alumni_external_job_sectors_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_alumni_external_job_sectors.getSecond(), locale, Alumni_external_job_sectors_Form.class);
