 ...
 *
 */
public class Action_new_page_area extends Action {
...
Action_new_page_area_Form action_new_page_area_Form=(Action_new_page_area_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_area_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_area_Form.class);
	...
	fbManager.setAttribute(area, "area_Form", Area_Form.class, action_new_page_area_Form.getArea_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAreaSys__action_new_page_area_Form", fbManager.getContainer());
