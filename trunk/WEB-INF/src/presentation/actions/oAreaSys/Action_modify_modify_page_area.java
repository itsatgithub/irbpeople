 ...
 *
 */
public class Action_modify_modify_page_area extends Action {
...
Action_modify_modify_page_area_Form action_modify_modify_page_area_Form=(Action_modify_modify_page_area_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_area_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Area area = UseCaseFacade.UpdateArea(usercode,(Area) fbManager.getPOJO("area_Form",Area.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "areacode="+area.getAreacode(), isPopUp, area.getCode(), area.toString());
