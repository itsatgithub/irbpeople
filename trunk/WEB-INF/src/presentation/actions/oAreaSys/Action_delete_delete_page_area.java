 ...
 *
 */
public class Action_delete_delete_page_area extends Action {
...
Action_delete_delete_page_area_Form action_delete_delete_page_area_Form=(Action_delete_delete_page_area_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_area_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveArea(usercode,action_delete_delete_page_area_Form.getAreacode());	
