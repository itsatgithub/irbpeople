 ...
 *
 */
public class Action_manage_area extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Area>> _list_area=UseCaseFacade.ObtainAllArea(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Area_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_area.getSecond(), locale, Area_Form.class);
