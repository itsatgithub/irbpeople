 ...
 *
 */
public class Action_new_page_alumni_titles extends Action {
...
Action_new_page_alumni_titles_Form action_new_page_alumni_titles_Form=(Action_new_page_alumni_titles_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_alumni_titles_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_titles alumni_titles = null;
...
fbManager=new FormBeanManager(request, Action_new_page_alumni_titles_Form.class);
	...
	fbManager.setAttribute(alumni_titles, "alumni_titles_Form", Alumni_titles_Form.class, action_new_page_alumni_titles_Form.getAlumni_titles_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_titlesSys__action_new_page_alumni_titles_Form", fbManager.getContainer());
