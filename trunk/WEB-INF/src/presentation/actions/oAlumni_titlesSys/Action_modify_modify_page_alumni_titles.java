 ...
 *
 */
public class Action_modify_modify_page_alumni_titles extends Action {
...
Action_modify_modify_page_alumni_titles_Form action_modify_modify_page_alumni_titles_Form=(Action_modify_modify_page_alumni_titles_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_alumni_titles_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Alumni_titles alumni_titles = UseCaseFacade.UpdateAlumni_titles(usercode,(Alumni_titles) fbManager.getPOJO("alumni_titles_Form",Alumni_titles.class));	
