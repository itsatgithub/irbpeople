 ...
 *
 */
public class Action_new_new_page_holiday extends Action {
...
Action_new_new_page_holiday_Form action_new_new_page_holiday_Form=(Action_new_new_page_holiday_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_holiday_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Holiday holiday = UseCaseFacade.CreateHoliday(usercode,(Holiday) fbManager.getPOJO("holiday_Form",Holiday.class));	
