 ...
 *
 */
public class Action_modify_modify_page_holiday extends Action {
...
Action_modify_modify_page_holiday_Form action_modify_modify_page_holiday_Form=(Action_modify_modify_page_holiday_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_holiday_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Holiday holiday = UseCaseFacade.UpdateHoliday(usercode,(Holiday) fbManager.getPOJO("holiday_Form",Holiday.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "holidaycode="+holiday.getHolidaycode(), isPopUp, holiday.getCode(), holiday.toString());
