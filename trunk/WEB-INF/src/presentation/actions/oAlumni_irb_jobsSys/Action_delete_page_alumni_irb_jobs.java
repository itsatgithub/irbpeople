...
import presentation.formbeans.oAlumni_irb_jobsSys.Action_delete_page_alumni_irb_jobs_Form;
 ...
 *
 */
public class Action_delete_page_alumni_irb_jobs extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_delete_page_alumni_irb_jobs_Form action_delete_page_alumni_irb_jobs_Form = (Action_delete_page_alumni_irb_jobs_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_alumni_irb_jobs_Form);

		/** 4.  We obtain the initial POJO. */

		Alumni_irb_jobs alumni_irb_jobs = UseCaseFacade.ObtainAlumni_irb_jobs(usercode, action_delete_page_alumni_irb_jobs_Form.getAlumni_irb_jobscode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_alumni_irb_jobs_Form.class);
		...
		fbManager.setAttribute(
				...
				action_delete_page_alumni_irb_jobs_Form.getAlumni_irb_jobs_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oAlumni_irb_jobsSys__action_delete_page_alumni_irb_jobs_Form", fbManager.getContainer());
