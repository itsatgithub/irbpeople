...
import presentation.formbeans.oAlumni_irb_jobsSys.Action_modify_modify_page_alumni_irb_jobs_Form;
 ...
 * 
 */
public class Action_modify_modify_page_alumni_irb_jobs extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Action_modify_modify_page_alumni_irb_jobs_Form action_modify_modify_page_alumni_irb_jobs_Form = (Action_modify_modify_page_alumni_irb_jobs_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request,
				action_modify_modify_page_alumni_irb_jobs_Form);

		/** 3. We use the business logic to modify the new item */

		Alumni_irb_jobs alumni_irb_jobs = UseCaseFacade.UpdateAlumni_irb_jobs(
				usercode, (Alumni_irb_jobs) fbManager.getPOJO(
						"alumni_irb_jobs_Form", Alumni_irb_jobs.class));
		...
		return NavigationFunctions.findForward(request, mapping, "success",
				"alumni_irb_jobscode=" + alumni_irb_jobs.getAlumni_irb_jobscode(),
				isPopUp, alumni_irb_jobs.getCode(), alumni_irb_jobs.toString());
