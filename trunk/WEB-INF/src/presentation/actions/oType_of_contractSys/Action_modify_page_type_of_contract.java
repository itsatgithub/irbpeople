package presentation.actions.oType_of_contractSys;
...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oType_of_contractSys.*;
 ...
 *
 */
public class Action_modify_page_type_of_contract extends Action {
...
Action_modify_page_type_of_contract_Form action_modify_page_type_of_contract_Form=(Action_modify_page_type_of_contract_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_type_of_contract_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_contract type_of_contract = UseCaseFacade.ObtainType_of_contract(usercode, action_modify_page_type_of_contract_Form.getType_of_contractcode());
...
fbManager=new FormBeanManager(request, Action_modify_page_type_of_contract_Form.class);
	...
	fbManager.setAttribute(type_of_contract, "type_of_contract_Form", Type_of_contract_Form.class, action_modify_page_type_of_contract_Form.getType_of_contract_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_contractSys__action_modify_page_type_of_contract_Form", fbManager.getContainer());
