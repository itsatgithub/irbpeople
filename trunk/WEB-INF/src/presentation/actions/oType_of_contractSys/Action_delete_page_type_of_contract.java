 ...
 *
 */
public class Action_delete_page_type_of_contract extends Action {
...
Action_delete_page_type_of_contract_Form action_delete_page_type_of_contract_Form=(Action_delete_page_type_of_contract_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_type_of_contract_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_contract type_of_contract = UseCaseFacade.ObtainType_of_contract(usercode, action_delete_page_type_of_contract_Form.getType_of_contractcode());
...
fbManager=new FormBeanManager(request, Action_delete_page_type_of_contract_Form.class);
	...
	fbManager.setAttribute(type_of_contract, "type_of_contract_Form", Type_of_contract_Form.class, action_delete_page_type_of_contract_Form.getType_of_contract_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_contractSys__action_delete_page_type_of_contract_Form", fbManager.getContainer());
