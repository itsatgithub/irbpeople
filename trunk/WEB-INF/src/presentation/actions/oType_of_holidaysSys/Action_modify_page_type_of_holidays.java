 ...
 *
 */
public class Action_modify_page_type_of_holidays extends Action {
...
Action_modify_page_type_of_holidays_Form action_modify_page_type_of_holidays_Form=(Action_modify_page_type_of_holidays_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_type_of_holidays_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_holidays type_of_holidays = UseCaseFacade.ObtainType_of_holidays(usercode, action_modify_page_type_of_holidays_Form.getType_of_holidayscode());
...
fbManager=new FormBeanManager(request, Action_modify_page_type_of_holidays_Form.class);
	...
	fbManager.setAttribute(type_of_holidays, "type_of_holidays_Form", Type_of_holidays_Form.class, action_modify_page_type_of_holidays_Form.getType_of_holidays_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_holidaysSys__action_modify_page_type_of_holidays_Form", fbManager.getContainer());
