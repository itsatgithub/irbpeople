 ...
 *
 */
public class Action_send_calendar_info extends Action {
    ...
    Action_send_calendar_info_Form action_send_calendar_info_Form=(Action_send_calendar_info_Form) form;

    FormBeanManager fbManager=new FormBeanManager(request, action_send_calendar_info_Form);
    
    Irbholidayinfo irbholidayinfo = UseCaseFacade.ObtainIrbholidayinfo(usercode, action_send_calendar_info_Form.getIrbholidayinfocode());
