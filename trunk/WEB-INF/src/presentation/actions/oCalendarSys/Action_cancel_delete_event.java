 ...
 *
 */
public class Action_cancel_delete_event extends Action {
    ...
    Action_cancel_delete_event_Form action_cancel_delete_event_Form=(Action_cancel_delete_event_Form) form;

    FormBeanManager fbManager=new FormBeanManager(request, action_cancel_delete_event_Form);
