...
import presentation.formbeans.oParamsSys.Action_modify_page_params_Form;
 ...
 * 
 */
public class Action_modify_page_params extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_modify_page_params_Form action_modify_page_params_Form = (Action_modify_page_params_Form) form;

		//Hardcoded param to edit
		action_modify_page_params_Form.setParamscode("MAX_LOGIN_TRIES");
		
		FormBeanManager fbManager = new FormBeanManager(request, action_modify_page_params_Form);

		/** 4. We obtain the initial POJO. */

		Params params = UseCaseFacade.ObtainParams(usercode, action_modify_page_params_Form.getParamscode());
		...
		fbManager = new FormBeanManager(request, Action_modify_page_params_Form.class);
		...
		fbManager.setAttribute(params, "params_Form", Params_Form.class, action_modify_page_params_Form.getParams_Form());

		/** 6.3. We add the container of the manager to the request. */

		request.setAttribute("oParamsSys__action_modify_page_params_Form", fbManager.getContainer());
