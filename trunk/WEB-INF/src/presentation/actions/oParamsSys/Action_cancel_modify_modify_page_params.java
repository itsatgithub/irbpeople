...
import presentation.formbeans.oParamsSys.Action_cancel_modify_modify_page_params_Form;
 ...
 * 
 */
public class Action_cancel_modify_modify_page_params extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_cancel_modify_modify_page_params_Form action_cancel_modify_modify_page_params_Form = (Action_cancel_modify_modify_page_params_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_cancel_modify_modify_page_params_Form);
