 ...
 *
 */
public class Action_new_new_page_location extends Action {
...
Action_new_new_page_location_Form action_new_new_page_location_Form=(Action_new_new_page_location_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_location_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Location location = UseCaseFacade.CreateLocation(usercode,(Location) fbManager.getPOJO("location_Form",Location.class));	
