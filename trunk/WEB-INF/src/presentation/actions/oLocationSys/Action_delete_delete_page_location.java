 ...
 *
 */
public class Action_delete_delete_page_location extends Action {
...
Action_delete_delete_page_location_Form action_delete_delete_page_location_Form=(Action_delete_delete_page_location_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_location_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveLocation(usercode,action_delete_delete_page_location_Form.getLocationcode());	
