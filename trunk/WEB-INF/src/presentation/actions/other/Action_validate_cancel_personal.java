 ...
 *
 */
public class Action_validate_cancel_personal extends Action {
...
String personalcode=((Personal) fbManager.getPOJO("personal_Form",Personal.class)).getCode();
	...
	UseCaseFacade.cancelValidatePersonal(usercode, personalcode, action_validate_personal_Form.getObservacions());
	
	UserUtils.addSessionSavedAuditMessage(request, "info.validationFail");
