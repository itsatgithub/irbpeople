 ...
 *
 */
public class Action_validate_validate_holidays extends Action {
...
FormBeanManager fbManager=new FormBeanManager(request, action_validate_holidays_Form);
	...
	UseCaseFacade.ChangeStateOfIrbholidayFromDemanatToAprovat(usercode, irbholiday, action_validate_holidays_Form.getObservacions());
	
	UserUtils.addSessionSavedAuditMessage(request, "info.validationHolidaysOk");
