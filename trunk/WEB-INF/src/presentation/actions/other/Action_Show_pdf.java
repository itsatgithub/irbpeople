 ...
 *
 */
public class Action_Show_pdf extends Action {
    ...
    throws Exception {    	    	    
        ...
        Action_reports_Form action_Show_pdf_Form=(Action_reports_Form) form;

        FormBeanManager fbManager=new FormBeanManager(request, action_Show_pdf_Form);			
