 ...
 *
 */
public class Action_manage_unit extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Unit>> _list_unit=UseCaseFacade.ObtainAllUnit(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Unit_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_unit.getSecond(), locale, Unit_Form.class);
