 ...
 *
 */
public class Action_modify_page_unit extends Action {
...
Action_modify_page_unit_Form action_modify_page_unit_Form=(Action_modify_page_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_unit_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Unit unit = UseCaseFacade.ObtainUnit(usercode, action_modify_page_unit_Form.getUnitcode());
...
fbManager=new FormBeanManager(request, Action_modify_page_unit_Form.class);
	...
	fbManager.setAttribute(unit, "unit_Form", Unit_Form.class, action_modify_page_unit_Form.getUnit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oUnitSys__action_modify_page_unit_Form", fbManager.getContainer());
