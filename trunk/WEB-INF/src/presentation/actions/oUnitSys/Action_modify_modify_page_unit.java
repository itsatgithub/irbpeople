 ...
 *
 */
public class Action_modify_modify_page_unit extends Action {
...
Action_modify_modify_page_unit_Form action_modify_modify_page_unit_Form=(Action_modify_modify_page_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_unit_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Unit unit = UseCaseFacade.UpdateUnit(usercode,(Unit) fbManager.getPOJO("unit_Form",Unit.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "unitcode="+unit.getUnitcode(), isPopUp, unit.getCode(), unit.toString());
