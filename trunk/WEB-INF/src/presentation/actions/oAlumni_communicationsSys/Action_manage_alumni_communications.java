 ...
 *
 */
public class Action_manage_alumni_communications extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Alumni_communications>> _list_alumni_communications=UseCaseFacade.ObtainAllAlumni_communications(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Alumni_communications_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_alumni_communications.getSecond(), locale, Alumni_communications_Form.class);
