 ...
 *
 */
public class Action_view_alumni_communications extends Action {
...
Action_view_alumni_communications_Form action_view_alumni_communications_Form=(Action_view_alumni_communications_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_alumni_communications_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_communications alumni_communications = UseCaseFacade.ObtainAlumni_communications(usercode, action_view_alumni_communications_Form.getAlumni_communicationscode());
...
fbManager=new FormBeanManager(request, Action_view_alumni_communications_Form.class);
	...
	fbManager.setAttribute(alumni_communications, "alumni_communications_Form", Alumni_communications_Form.class, action_view_alumni_communications_Form.getAlumni_communications_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_communicationsSys__action_view_alumni_communications_Form", fbManager.getContainer());
