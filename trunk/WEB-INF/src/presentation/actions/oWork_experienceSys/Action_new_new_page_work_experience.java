 ...
 *
 */
public class Action_new_new_page_work_experience extends Action {
...
Action_new_new_page_work_experience_Form action_new_new_page_work_experience_Form=(Action_new_new_page_work_experience_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_work_experience_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Work_experience work_experience = UseCaseFacade.CreateWork_experience(usercode,(Work_experience) fbManager.getPOJO("work_experience_Form",Work_experience.class));	
