 ...
 *
 */
public class Action_add_my_own_work_experience extends Action {
...
Action_add_my_own_work_experience_Form action_add_my_own_work_experience_Form=(Action_add_my_own_work_experience_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_my_own_work_experience_Form);
...
fbManager=new FormBeanManager(request, Action_add_my_own_work_experience_Form.class);
	...
	fbManager.setAttribute(work_experience, "work_experience_Form", Work_experience_Form.class, action_add_my_own_work_experience_Form.getWork_experience_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oWork_experienceSys__action_add_my_own_work_experience_Form", fbManager.getContainer());
...
List<Type_of_institution_Form> _selec_type_of_institution_Form = ExtendedBeanUtils.copyPropertiesToFormBean(_selec_type_of_institution.getSecond(), locale, Type_of_institution_Form.class);
