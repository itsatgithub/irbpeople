 ...
 *
 */
public class Action_new_new_page_child extends Action {
...
Action_new_new_page_child_Form action_new_new_page_child_Form=(Action_new_new_page_child_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_child_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Child child = UseCaseFacade.CreateChild(usercode,(Child) fbManager.getPOJO("child_Form",Child.class));	
