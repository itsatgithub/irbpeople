 ...
 *
 */
public class Action_delete_delete_page_child extends Action {
...
Action_delete_delete_page_child_Form action_delete_delete_page_child_Form=(Action_delete_delete_page_child_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_child_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveChild(usercode,action_delete_delete_page_child_Form.getChildcode());	
