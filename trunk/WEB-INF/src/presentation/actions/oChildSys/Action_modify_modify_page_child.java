 ...
 *
 */
public class Action_modify_modify_page_child extends Action {
...
Action_modify_modify_page_child_Form action_modify_modify_page_child_Form=(Action_modify_modify_page_child_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_child_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Child child = UseCaseFacade.UpdateChild(usercode,(Child) fbManager.getPOJO("child_Form",Child.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "childcode="+child.getChildcode(), isPopUp, child.getCode(), child.toString());
