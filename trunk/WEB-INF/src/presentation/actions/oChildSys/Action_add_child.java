 ...
 *
 */
public class Action_add_child extends Action {
...
Action_add_child_Form action_add_child_Form=(Action_add_child_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_child_Form);
...
fbManager=new FormBeanManager(request, Action_add_child_Form.class);
	...
	fbManager.setAttribute(child, "child_Form", Child_Form.class, action_add_child_Form.getChild_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oChildSys__action_add_child_Form", fbManager.getContainer());
