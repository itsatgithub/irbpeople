package presentation.actions.oChildSys;
...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oChildSys.*;
 ...
 *
 */
public class Action_modify_page_child extends Action {
...
Action_modify_page_child_Form action_modify_page_child_Form=(Action_modify_page_child_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_child_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Child child = UseCaseFacade.ObtainChild(usercode, action_modify_page_child_Form.getChildcode());
...
fbManager=new FormBeanManager(request, Action_modify_page_child_Form.class);
	...
	fbManager.setAttribute(child, "child_Form", Child_Form.class, action_modify_page_child_Form.getChild_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oChildSys__action_modify_page_child_Form", fbManager.getContainer());
