...
import presentation.formbeans.oResearch_groupSys.Action_delete_page_research_group_Form;
 ...
 *
 */
public class Action_delete_page_research_group extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_delete_page_research_group_Form action_delete_page_research_group_Form = (Action_delete_page_research_group_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_research_group_Form);

		/** 4.  We obtain the initial POJO. */

		Research_group research_group = UseCaseFacade.ObtainResearch_group(usercode, action_delete_page_research_group_Form.getResearch_groupcode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_research_group_Form.class);
		...
		fbManager.setAttribute(
				...
				action_delete_page_research_group_Form.getResearch_group_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oResearch_groupSys__action_delete_page_research_group_Form", fbManager.getContainer());
