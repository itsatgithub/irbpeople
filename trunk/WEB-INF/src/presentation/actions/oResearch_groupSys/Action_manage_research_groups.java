 ...
 *
 */
public class Action_manage_research_groups extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Research_group>> _list_research_group=UseCaseFacade.ObtainAllResearch_group(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Research_group_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_research_group.getSecond(), locale, Research_group_Form.class);
