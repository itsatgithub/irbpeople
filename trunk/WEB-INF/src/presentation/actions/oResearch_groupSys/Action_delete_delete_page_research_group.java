 ...
 *
 */
public class Action_delete_delete_page_research_group extends Action {
...
Action_delete_delete_page_research_group_Form action_delete_delete_page_research_group_Form=(Action_delete_delete_page_research_group_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_research_group_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveResearch_group(usercode,action_delete_delete_page_research_group_Form.getResearch_groupcode());	
