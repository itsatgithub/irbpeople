 ...
 *
 */
public class Action_new_new_page_research_group extends Action {
...
Action_new_new_page_research_group_Form action_new_new_page_research_group_Form=(Action_new_new_page_research_group_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_research_group_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Research_group research_group = UseCaseFacade.CreateResearch_group(usercode,(Research_group) fbManager.getPOJO("research_group_Form",Research_group.class));	
