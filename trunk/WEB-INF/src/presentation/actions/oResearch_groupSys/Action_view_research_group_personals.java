...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oResearch_groupSys.*;
 ...
 *
 */
public class Action_view_research_group_personals extends Action {
...
Action_view_research_group_personals_Form action_view_research_group_personals_Form=(Action_view_research_group_personals_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_research_group_personals_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Research_group research_group = UseCaseFacade.ObtainResearch_group(usercode, action_view_research_group_personals_Form.getResearch_groupcode());
...
fbManager=new FormBeanManager(request, Action_view_research_group_personals_Form.class);
	...
	fbManager.setAttribute(research_group, "research_group_Form", Research_group_Form.class, action_view_research_group_personals_Form.getResearch_group_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oResearch_groupSys__action_view_research_group_personals_Form", fbManager.getContainer());
...
request.setAttribute("_selec_unit", _selec_unit_Form);
	...
	/** 6.5.2.  We obtain the list of objects form the Business logic */
			...
			Pair<Integer,List<Professional>> _list_professional=UseCaseFacade.ObtainAllIresearch_groupFromResearch_group(usercode,action_view_research_group_personals_Form.getResearch_group_Form().getResearch_groupcode(),filter.obtainListConfigurator(locale, true));
	
	/** 6.5.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Professional_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_professional.getSecond(), locale, Professional_Form.class);
