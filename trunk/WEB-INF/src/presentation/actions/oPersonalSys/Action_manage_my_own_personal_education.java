 ...
 *
 */
public class Action_manage_my_own_personal_education extends Action {
...
Action_manage_my_own_personal_education_Form action_manage_my_own_personal_education_Form=(Action_manage_my_own_personal_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_manage_my_own_personal_education_Form);
...
fbManager=new FormBeanManager(request, Action_manage_my_own_personal_education_Form.class);
	...
	fbManager.setAttribute(personal, "personal_Form", Personal_Form.class, action_manage_my_own_personal_education_Form.getPersonal_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPersonalSys__action_manage_my_own_personal_education_Form", fbManager.getContainer());
	...
	/** 6.5.2.  We obtain the list of objects form the Business logic */
			...
			Pair<Integer,List<Education>> _list_education=UseCaseFacade.ObtainAllIeducation_personalFromPersonal(usercode,action_manage_my_own_personal_education_Form.getPersonal_Form().getPersonalcode(),filter.obtainListConfigurator(locale, false));
