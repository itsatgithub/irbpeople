 ...
 * 
 */
public class Action_manage_personal_with_grant extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Pair<Integer, Pair<List<Personal>, Map<String, String[]>>> _list_personal = UseCaseFacade
                .ObtainPersonalWithGrantAndOrderMap(usercode, filter.obtainListConfigurator(locale, true));
        ...
        List<Personal_Form> viewlistElements = ExtendedBeanUtils.copyPropertiesToFormBean(_list_personal.getSecond()
                .getFirst(), locale, Personal_Form.class);
