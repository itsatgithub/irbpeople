 ...
 *
 */
public class Action_change_state_from_validating_to_validated_modify_modify_page_personal extends Action {
...
Action_change_state_from_validating_to_validated_modify_modify_page_personal_Form action_change_state_from_validating_to_progress_modify_modify_page_personal_Form=(Action_change_state_from_validating_to_validated_modify_modify_page_personal_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_change_state_from_validating_to_progress_modify_modify_page_personal_Form);			
...
String personalcode=((Personal) fbManager.getPOJO("personal_Form",Personal.class)).getCode();
	...
	Personal personal = UseCaseFacade.changeStateOfPersonalFromValidatingToValidated(usercode, personalcode);
