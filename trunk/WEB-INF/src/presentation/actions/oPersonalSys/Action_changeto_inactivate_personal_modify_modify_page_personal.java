 ...
 *
 */
public class Action_changeto_inactivate_personal_modify_modify_page_personal extends Action {
...
Action_changeto_inactivate_personal_modify_modify_page_personal_Form action_changeto_inactivate_personal_modify_modify_page_personal_Form=(Action_changeto_inactivate_personal_modify_modify_page_personal_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_changeto_inactivate_personal_modify_modify_page_personal_Form);			
		
	/** 3.  We use the business logic to modify the new item */

Personal personal = UseCaseFacade.changeStateOfPersonalFromActiveToInactive(usercode, (Personal) fbManager.getPOJO("personal_Form",Personal.class));
