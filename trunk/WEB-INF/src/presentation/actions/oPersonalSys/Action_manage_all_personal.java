 ...
 *
 */
public class Action_manage_all_personal extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Pair<Integer, Pair<List<Personal>, Map<String, String[]>>> _list_personal =
				UseCaseFacade.ObtainAllPersonalAndOrderMap(usercode, filter.obtainListConfigurator(locale, true));
