 ...
 *
 */
public class Action_view_details extends Action {
...
Action_view_details_Form action_view_details_Form=(Action_view_details_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_details_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Personal personal = UseCaseFacade.ObtainPersonal(usercode, action_view_details_Form.getPersonalcode());
...
fbManager=new FormBeanManager(request, Action_view_details_Form.class);
	...
	fbManager.setAttribute(personal, "personal_Form", Personal_Form.class, action_view_details_Form.getPersonal_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPersonalSys__action_view_details_Form", fbManager.getContainer());
