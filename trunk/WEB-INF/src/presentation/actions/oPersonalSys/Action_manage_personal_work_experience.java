 ...
 * 
 */
public class Action_manage_personal_work_experience extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Action_manage_personal_work_experience_Form action_manage_personal_work_experience_Form = (Action_manage_personal_work_experience_Form) form;

        FormBeanManager fbManager = new FormBeanManager(request, action_manage_personal_work_experience_Form);

        /** 4. We obtain the initial POJO. */

        Personal personal = UseCaseFacade.ObtainPersonal(usercode, action_manage_personal_work_experience_Form
                .getPersonalcode());
        ...
        BOAdderFormBean<Personal_comment_Form> boAdderFormBean2 = action_manage_personal_work_experience_Form
        ...
        List<Personal_comment> boAdderList2 = Personal_comments_methods.process_personal_comments(boAdderFormBean2,
                fbManager, action_manage_personal_work_experience_Form.getPersonalcode(), usercode);
        ...
        fbManager = new FormBeanManager(request, Action_manage_personal_work_experience_Form.class);
        ...
        fbManager.setAttribute(personal, "personal_Form", Personal_Form.class,
                action_manage_personal_work_experience_Form.getPersonal_Form());

        /** 6.3. We add the container of the manager to the request. */

        request.setAttribute("oPersonalSys__action_manage_personal_work_experience_Form", fbManager.getContainer());
        ...
        Pair<Integer, List<Work_experience>> _list_work_experience = UseCaseFacade
                .ObtainAllIwork_experience_personalFromPersonal(usercode, action_manage_personal_work_experience_Form
        ...
        List<Work_experience_Form> viewlistElements = ExtendedBeanUtils.copyPropertiesToFormBean(_list_work_experience
                .getSecond(), locale, Work_experience_Form.class);
