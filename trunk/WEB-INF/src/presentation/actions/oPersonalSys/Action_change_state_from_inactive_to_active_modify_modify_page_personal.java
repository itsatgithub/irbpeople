 ...
 *
 */
public class Action_change_state_from_inactive_to_active_modify_modify_page_personal extends Action {
...
Action_change_state_from_inactive_to_active_modify_modify_page_personal_Form action_change_state_from_inactive_to_active_modify_modify_page_personal_Form=(Action_change_state_from_inactive_to_active_modify_modify_page_personal_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_change_state_from_inactive_to_active_modify_modify_page_personal_Form);			
...
Personal personal = UseCaseFacade.changeStateOfPersonalFromInactiveToActive(usercode, personalcode);
