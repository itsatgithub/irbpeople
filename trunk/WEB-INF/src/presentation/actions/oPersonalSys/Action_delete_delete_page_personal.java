 ...
 *
 */
public class Action_delete_delete_page_personal extends Action {
...
Action_delete_delete_page_personal_Form action_delete_delete_page_personal_Form=(Action_delete_delete_page_personal_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_personal_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemovePersonal(usercode,action_delete_delete_page_personal_Form.getPersonalcode());	
