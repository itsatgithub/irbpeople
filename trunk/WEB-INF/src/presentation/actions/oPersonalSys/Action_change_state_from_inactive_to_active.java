 ...
 *
 */
public class Action_change_state_from_inactive_to_active extends Action {
...
Action_change_state_from_inactive_to_active_Form action_change_state_from_inactive_to_active_Form=(Action_change_state_from_inactive_to_active_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_change_state_from_inactive_to_active_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Personal personal = UseCaseFacade.ObtainPersonal(usercode, action_change_state_from_inactive_to_active_Form.getPersonalcode());
...
fbManager=new FormBeanManager(request, Action_change_state_from_inactive_to_active_Form.class);
	...
	fbManager.setAttribute(personal, "personal_Form", Personal_Form.class, action_change_state_from_inactive_to_active_Form.getPersonal_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPersonalSys__action_change_state_from_inactive_to_active_Form", fbManager.getContainer());
