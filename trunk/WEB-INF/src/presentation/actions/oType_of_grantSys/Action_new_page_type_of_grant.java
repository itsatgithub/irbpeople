 ...
 *
 */
public class Action_new_page_type_of_grant extends Action {
...
Action_new_page_type_of_grant_Form action_new_page_type_of_grant_Form=(Action_new_page_type_of_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_grant_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_grant type_of_grant = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_grant_Form.class);
	...
	fbManager.setAttribute(type_of_grant, "type_of_grant_Form", Type_of_grant_Form.class, action_new_page_type_of_grant_Form.getType_of_grant_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_grantSys__action_new_page_type_of_grant_Form", fbManager.getContainer());
