 ...
 *
 */
public class Action_manage_type_of_grant extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_grant>> _list_type_of_grant=UseCaseFacade.ObtainAllType_of_grant(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_grant_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_grant.getSecond(), locale, Type_of_grant_Form.class);
