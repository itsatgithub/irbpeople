...
import presentation.formbeans.oAcademic_infoSys.Action_delete_delete_page_academic_info_Form;
 ...
 *
 */
public class Action_delete_delete_page_academic_info extends Action {
...
Action_delete_delete_page_academic_info_Form action_delete_delete_page_academic_info_Form=(Action_delete_delete_page_academic_info_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_academic_info_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveAcademic_info(usercode,action_delete_delete_page_academic_info_Form.getAcademic_infocode());	
