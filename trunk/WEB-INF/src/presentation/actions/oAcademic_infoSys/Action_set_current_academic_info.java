 ...
 *
 */
public class Action_set_current_academic_info extends Action {
    ...
    throws Exception {                  
        ...
        String personalcode = UseCaseFacade.SetCurrentAcademic_info(usercode, action_delete_page_academic_info_Form.getAcademic_infocode());
