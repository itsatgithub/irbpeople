 ...
 *
 */
public class Action_delete_page_academic_info extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_academic_info_Form);

		/** 4.  We obtain the initial POJO. */

		Academic_info academic_info = UseCaseFacade.ObtainAcademic_info(usercode, action_delete_page_academic_info_Form.getAcademic_infocode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_academic_info_Form.class);
		...
		request.setAttribute("oAcademic_infoSys__action_delete_page_academic_info_Form", fbManager.getContainer());
