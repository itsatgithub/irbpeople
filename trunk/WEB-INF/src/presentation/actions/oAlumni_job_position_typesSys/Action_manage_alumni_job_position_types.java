 ...
 *
 */
public class Action_manage_alumni_job_position_types extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Alumni_job_position_types>> _list_alumni_job_position_types=UseCaseFacade.ObtainAllAlumni_job_position_types(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Alumni_job_position_types_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_alumni_job_position_types.getSecond(), locale, Alumni_job_position_types_Form.class);
