 ...
 *
 */
public class Action_new_new_page_alumni_job_position_types extends Action {
...
Action_new_new_page_alumni_job_position_types_Form action_new_new_page_alumni_job_position_types_Form=(Action_new_new_page_alumni_job_position_types_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_alumni_job_position_types_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Alumni_job_position_types alumni_job_position_types = UseCaseFacade.CreateAlumni_job_position_types(usercode,(Alumni_job_position_types) fbManager.getPOJO("alumni_job_position_types_Form",Alumni_job_position_types.class));	
