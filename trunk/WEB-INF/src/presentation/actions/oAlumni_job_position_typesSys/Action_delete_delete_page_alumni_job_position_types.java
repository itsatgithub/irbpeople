 ...
 *
 */
public class Action_delete_delete_page_alumni_job_position_types extends Action {
...
Action_delete_delete_page_alumni_job_position_types_Form action_delete_delete_page_alumni_job_position_types_Form=(Action_delete_delete_page_alumni_job_position_types_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_alumni_job_position_types_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveAlumni_job_position_types(usercode,action_delete_delete_page_alumni_job_position_types_Form.getAlumni_job_position_typescode());	
