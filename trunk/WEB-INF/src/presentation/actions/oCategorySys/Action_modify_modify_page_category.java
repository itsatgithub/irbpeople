 ...
 *
 */
public class Action_modify_modify_page_category extends Action {
...
Action_modify_modify_page_category_Form action_modify_modify_page_category_Form=(Action_modify_modify_page_category_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_category_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Category category = UseCaseFacade.UpdateCategory(usercode,(Category) fbManager.getPOJO("category_Form",Category.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "categorycode="+category.getCategorycode(), isPopUp, category.getCode(), category.toString());
