 ...
 *
 */
public class Action_modify_modify_page_bank extends Action {
...
Action_modify_modify_page_bank_Form action_modify_modify_page_bank_Form=(Action_modify_modify_page_bank_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_bank_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Bank bank = UseCaseFacade.UpdateBank(usercode,(Bank) fbManager.getPOJO("bank_Form",Bank.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "bankcode="+bank.getBankcode(), isPopUp, bank.getCode(), bank.toString());
