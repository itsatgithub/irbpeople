 ...
 *
 */
public class Action_new_new_page_bank extends Action {
...
Action_new_new_page_bank_Form action_new_new_page_bank_Form=(Action_new_new_page_bank_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_bank_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Bank bank = UseCaseFacade.CreateBank(usercode,(Bank) fbManager.getPOJO("bank_Form",Bank.class));	
