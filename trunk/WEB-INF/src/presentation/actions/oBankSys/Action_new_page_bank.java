 ...
 *
 */
public class Action_new_page_bank extends Action {
...
Action_new_page_bank_Form action_new_page_bank_Form=(Action_new_page_bank_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_bank_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_bank_Form.class);
	...
	fbManager.setAttribute(bank, "bank_Form", Bank_Form.class, action_new_page_bank_Form.getBank_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oBankSys__action_new_page_bank_Form", fbManager.getContainer());
