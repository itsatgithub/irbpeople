 ...
 *
 */
public class Action_delete_delete_page_working_hours extends Action {
...
Action_delete_delete_page_working_hours_Form action_delete_delete_page_working_hours_Form=(Action_delete_delete_page_working_hours_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_working_hours_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveWorking_hours(usercode,action_delete_delete_page_working_hours_Form.getWorking_hourscode());	
