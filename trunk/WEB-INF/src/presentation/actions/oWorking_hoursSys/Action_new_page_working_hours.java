 ...
 *
 */
public class Action_new_page_working_hours extends Action {
...
Action_new_page_working_hours_Form action_new_page_working_hours_Form=(Action_new_page_working_hours_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_working_hours_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_working_hours_Form.class);
	...
	fbManager.setAttribute(working_hours, "working_hours_Form", Working_hours_Form.class, action_new_page_working_hours_Form.getWorking_hours_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oWorking_hoursSys__action_new_page_working_hours_Form", fbManager.getContainer());
