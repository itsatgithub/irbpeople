 ...
 *
 */
public class Action_modify_page_type_of_compensation extends Action {
...
Action_modify_page_type_of_compensation_Form action_modify_page_type_of_compensation_Form=(Action_modify_page_type_of_compensation_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_type_of_compensation_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_compensation type_of_compensation = UseCaseFacade.ObtainType_of_compensation(usercode, action_modify_page_type_of_compensation_Form.getType_of_compensationcode());
...
fbManager=new FormBeanManager(request, Action_modify_page_type_of_compensation_Form.class);
	...
	fbManager.setAttribute(type_of_compensation, "type_of_compensation_Form", Type_of_compensation_Form.class, action_modify_page_type_of_compensation_Form.getType_of_compensation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_compensationSys__action_modify_page_type_of_compensation_Form", fbManager.getContainer());
