 ...
 *
 */
public class Action_add_my_own_grant_concession extends Action {
...
Action_add_my_own_grant_concession_Form action_add_my_own_grant_concession_Form=(Action_add_my_own_grant_concession_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_my_own_grant_concession_Form);
...
fbManager=new FormBeanManager(request, Action_add_my_own_grant_concession_Form.class);
	...
	fbManager.setAttribute(grant_concession, "grant_concession_Form", Grant_concession_Form.class, action_add_my_own_grant_concession_Form.getGrant_concession_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oGrant_concessionSys__action_add_my_own_grant_concession_Form", fbManager.getContainer());
