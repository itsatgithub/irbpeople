 ...
 *
 */
public class Action_delete_delete_page_grant_concession extends Action {
...
Action_delete_delete_page_grant_concession_Form action_delete_delete_page_grant_concession_Form=(Action_delete_delete_page_grant_concession_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_grant_concession_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveGrant_concession(usercode,action_delete_delete_page_grant_concession_Form.getGrant_concessioncode());	
