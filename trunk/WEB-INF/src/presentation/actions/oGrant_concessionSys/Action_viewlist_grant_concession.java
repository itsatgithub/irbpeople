 ...
 *
 */
public class Action_viewlist_grant_concession extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Grant_concession>> _list_grant_concession=UseCaseFacade.ObtainAllGrant_concession(usercode,filter.obtainListConfigurator(locale, false));
