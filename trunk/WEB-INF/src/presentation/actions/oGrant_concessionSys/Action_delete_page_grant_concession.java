...
import presentation.formbeans.oGrant_concessionSys.Action_delete_page_grant_concession_Form;
 ...
 *
 */
public class Action_delete_page_grant_concession extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_delete_page_grant_concession_Form action_delete_page_grant_concession_Form = (Action_delete_page_grant_concession_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_grant_concession_Form);

		/** 4.  We obtain the initial POJO. */

		Grant_concession grant_concession = UseCaseFacade.ObtainGrant_concession(usercode, action_delete_page_grant_concession_Form.getGrant_concessioncode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_grant_concession_Form.class);
		...
		fbManager.setAttribute(
				...
				action_delete_page_grant_concession_Form.getGrant_concession_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oGrant_concessionSys__action_delete_page_grant_concession_Form", fbManager.getContainer());
