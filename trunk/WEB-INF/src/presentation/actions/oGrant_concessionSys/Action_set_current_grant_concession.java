 ...
 *
 */
public class Action_set_current_grant_concession extends Action {
    ...
    throws Exception {                  
        ...
        String personalcode = UseCaseFacade.SetCurrentGrant_concession(usercode, action_delete_page_grant_concession_Form.getGrant_concessioncode());
