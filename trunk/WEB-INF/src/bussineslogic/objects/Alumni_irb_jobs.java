 ...
 * 
 */
public class Alumni_irb_jobs implements Persistent {

	// Code (primary key) of this alumni_titles
	private String alumni_irb_jobscode;
	...
	/**
	 * Default Constructor which creates an empty alumni_irb_jobs
	 */
	public Alumni_irb_jobs() {
	}

	/**
	 * Returns the code (primary key) of this alumni_irb_jobs.
	 * 
	 ...
	 * which calls
	 * {@link bussineslogic.objects.alumni_irb_job#setAlumni_irb_jobscode(String)
	 * setAlumni_irb_jobscode(String)}
	 * 
	 * @param alumni_irb_jobscode
	 *            the String with the code
	 */
	public void setCode(String alumni_irb_jobscode) {
		setAlumni_irb_jobscode(alumni_irb_jobscode);
	}
