...
Set<Personal> igender=new HashSet<Personal>();
	 ...
	 * @param gendercode the String with the code
	 */
	...
	/**
	 * Returns the code (primary key) of this gender. Convenience method which calls {@link bussineslogic.objects.Gender#getGendercode() getGendercode()}
	 * @return a String with the code
	 */
	...
	/**
	 * Set the code (primary key) of this gender. Convenience method which calls {@link bussineslogic.objects.Gender#setGendercode(String) getGendercode(String)}
	 * @param gendercode the String with the code
	 */
...
* @param igender Personal to be added
*/
...
* @param igender Personal to be removed
*/
