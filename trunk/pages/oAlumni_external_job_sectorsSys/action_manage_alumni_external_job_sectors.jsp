...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectname" value="alumni_external_job_sectors"/>
	<jsp:param name="objectfield" value="oAlumni_external_job_sectorsSys__action_manage_alumni_external_job_sectors"/>
