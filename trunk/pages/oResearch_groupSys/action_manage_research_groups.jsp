	...
	<table cellpadding=0 cellspacing=0>
		...
		<tr align="center">
			...
			<table class="FormTable" cellpadding=0 cellspacing=0>
				...
				<tr>
					<td><jsp:include page="/pages/common/lists/viewlist.jsp"
						flush="true">
						<jsp:param name="selectionType" value="ROWACTION" />
						<jsp:param name="objectname" value="research_group" />
						<jsp:param name="objectfield"
							value="oResearch_groupSys__action_manage_research_groups" />
