...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectname" value="alumni_external_job_positions"/>
	<jsp:param name="objectfield" value="oAlumni_external_job_positionsSys__action_manage_alumni_external_job_positions"/>
