...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="academic_info.new"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<tr>
	<td align="center">
	<nested:nest property="academic_info_Form">
	<nested:hidden property="academic_info_personal.personalcode"/>
