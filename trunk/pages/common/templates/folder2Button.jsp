...
<table border=0 cellpadding=0 cellspacing=0 class="actiontrayout"
	...
	<tr height=25px>
		...
		<td style="{white-space: nowrap}" class=<%=param_folder_style%>
			...
			onmouseout="this.className='actiontrayout';"
			onmouseover="this.className='actiontrayover';"
	...
	<tr>
		<td height="3px" colspan="5"
			background="<%=JspUtils.getProjectPath(request)%>/images/gui/folder-border-line.gif"></td>
	</tr>
</table>
