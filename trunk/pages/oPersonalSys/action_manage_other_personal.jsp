...
<jsp:include page="/pages/common/lists/filter.jsp" flush="true">
	<jsp:param name="reportfield" value="oPersonalSys__action_manage_other_personal"/>
</jsp:include>
</td></tr>
<tr><td>
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectfield" value="oPersonalSys__action_manage_other_personal"/>
