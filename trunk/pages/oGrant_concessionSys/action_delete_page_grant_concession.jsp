...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="grant_concession.delete"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<tr>
	...
	<td class="FormFieldRight">
		<nested:write property="start_date_msc_or_phd" />
	</td>
</tr>
...
<tr>
	...
	<td class="FormFieldRight">
		<nested:write property="name_master_or_programme" />
	</td>
</tr>
...
<td class="FormFieldRight">
	<nested:write property="call_code"/>
