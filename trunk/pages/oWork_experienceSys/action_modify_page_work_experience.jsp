...
<%@page import="presentation.formbeans.oWork_experienceSys.Action_modify_page_work_experience_Form" %>
...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="work_experience.modify"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<jim:message key="work/spexperience/spperson" />
	
</td>
<td class="FormFieldRight">
	<nested:write property="work_experience_personal"/>
...
<nested:text property="name_of_institution_or_company" maxlength="100" size="35"/>
...
<nested:text property="department" maxlength="45" size="35"/>
...
<%
	...
	Action_modify_page_work_experience_Form form = (Action_modify_page_work_experience_Form)request.getAttribute("oWork_experienceSys__action_modify_page_work_experience_Form");
	String areacode = form.getWork_experience_Form().getArea().getAreacode();
	
	if(areacode != null && areacode.equals("99999")) 
	{
%>	
<nested:text styleId="positionText" property="position" maxlength="45" disabled="true" style="display:none" size="35"/>

<nested-jim:TagSelect styleId="positionSelect" property="position"  disabled="false" style="display:inline">
...
<%
	...
	{
%>
<nested:text styleId="positionText" property="position" maxlength="45" disabled="false" size="35"/>
