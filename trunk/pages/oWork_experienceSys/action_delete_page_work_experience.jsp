...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="work_experience.delete"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<td class="FormFieldRight">
	<nested:write property="type_of_institution"/>
...
<td class="FormFieldRight">
	<nested:write property="name_of_institution_or_company"/>
...
<td class="FormFieldRight">
	<nested:write property="work_experience_country"/>
