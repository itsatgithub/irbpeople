...
<jsp:include page="/pages/common/lists/filter.jsp" flush="true">
	<jsp:param name="reportfield" value="oAlumni_personalSys__action_manage_not_validated_alumni_personal"/>
</jsp:include>
</td></tr>
<tr><td>
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	<jsp:param name="selectionType" value="ROWACTION"/>
	<jsp:param name="objectname" value="alumni_personal"/>
	<jsp:param name="objectfield" value="oAlumni_personalSys__action_manage_not_validated_alumni_personal"/>
