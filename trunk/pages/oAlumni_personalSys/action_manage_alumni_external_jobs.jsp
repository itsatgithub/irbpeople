...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="alumni_external_jobs"/> </jsp:include></td>
	</tr>
	<tr align="center">
		<td class="GroupContent">
			<table class="FormTable" cellpadding=0 cellspacing=0>
...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectname" value="alumni_external_jobs"/>
	<jsp:param name="objectfield" value="oAlumni_personalSys__action_manage_alumni_personal_alumni_external_jobs"/>
