...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="holiday.modify"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<nested-jim:TagSelect property="holiday_personal.personalcode"  >
