...
<table cellpadding=0 cellspacing=0>
	<tr>
		<td><jsp:include page="/pages/common/templates/groupHeader.jsp"> <jsp:param name="HeaderKey" value="holiday.delete"/> </jsp:include></td>
	</tr>
	<tr align="center">
...
<jim:message key="holiday/spperson" />
	
</td>
<td class="FormFieldRight">
	<nested:write property="holiday_personal"/>
...
<td class="FormFieldRight">
	<nested:write property="type_of_holiday"/>
