...
<jsp:include page="/pages/common/lists/viewlist.jsp" flush="true">
	...
	<jsp:param name="objectname" value="alumni_job_position_types"/>
	<jsp:param name="objectfield" value="oAlumni_job_position_typesSys__action_manage_alumni_job_position_types"/>
