...
/**
 * This class is a modification of the class PropertyUtilsBean.
 * 
 * @author Automatika - JustInMind SL
 *
 */

public class JIMPropertyUtilsBean {

    // --------------------------------------------------------- Class Methods
    
    protected static JIMPropertyUtilsBean getInstance(Locale locale) {
        return JIMBeanUtilsBean.getInstance(locale).getPropertyUtils();
    }	
