...
String building;
	 ...
	 * @param professionalcode the String with the code
	 */
	...
	/**
	 * Returns the code (primary key) of this professional. Convenience method which calls {@link bussineslogic.objects.Professional#getProfessionalcode() getProfessionalcode()}
	 * @return a String with the code
	 */
	...
	/**
	 * Set the code (primary key) of this professional. Convenience method which calls {@link bussineslogic.objects.Professional#setProfessionalcode(String) getProfessionalcode(String)}
	 * @param professionalcode the String with the code
	 */
...
/**
* @param professional_personal the professional_personal to set.
*/
...
/**
* @param research_group the research_group to set.
*/
...
/**
* @param professional_unit the professional_unit to set.
*/
...
/**
* @param payroll_institution the payroll_institution to set.
*/
public void setPayroll_institution(Payroll_institution payroll_institution){
	...
	public void setPayroll_institution_2(Payroll_institution payroll_institution_2) {
