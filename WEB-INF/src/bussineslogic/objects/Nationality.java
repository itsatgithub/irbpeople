...
Set<Personal> inationality_2=new HashSet<Personal>();
	 ...
	 * @param nationalitycode the String with the code
	 */
	...
	/**
	 * Returns the code (primary key) of this nationality. Convenience method which calls {@link bussineslogic.objects.Nationality#getNationalitycode() getNationalitycode()}
	 * @return a String with the code
	 */
	...
	/**
	 * Set the code (primary key) of this nationality. Convenience method which calls {@link bussineslogic.objects.Nationality#setNationalitycode(String) getNationalitycode(String)}
	 * @param nationalitycode the String with the code
	 */
...
/**
* @param inationality the inationality to set.
*/
...
* @param inationality Personal to be added
*/
...
* @param inationality Personal to be removed
*/
...
/**
* @param inationality_2 the inationality_2 to set.
*/
...
* @param inationality_2 Personal to be added
*/
...
* @param inationality_2 Personal to be removed
*/
