...
/**
 * This class is a FormBeanContainer for the action action_modify_page_research_group.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_page_research_group_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setResearch_group_Form(Research_group_Form research_group_Form){
			...
			public String getMainFormBeanCode() {
				...
				/**
				* shortcut of getResearch_group_Form().getSupervisor()
				* @return the personal
				*/
				public Personal_IDForm getSupervisor(){
					return getResearch_group_Form().getSupervisor();
				}
				
				/**
				* shortcut of getResearch_group_Form().setSupervisor(personal
				* @param personal the new personal
				**/
				public void setSupervisor(Personal_IDForm personal){
					getResearch_group_Form().setSupervisor(personal);
				}
