...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_irb_job_positions.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_irb_job_positions_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_alumni_irb_job_positionscode the new code
		 */
		
		public void setAlumni_irb_job_positionscode(String alumni_alumni_irb_job_positionscode){
			
			getAlumni_irb_job_positions_Form().setAlumni_irb_job_positionscode(alumni_alumni_irb_job_positionscode);
		}
