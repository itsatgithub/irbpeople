...
/**
 * This class is a FormBeanContainer for the action action_delete_delete_page_alumni_external_job_positions.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_delete_delete_page_alumni_external_job_positions_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_external_job_positionscode the new code
		 */
		
		public void setAlumni_external_job_positionscode(String alumni_external_job_positionscode){
			
			getAlumni_external_job_positions_Form().setAlumni_external_job_positionscode(alumni_external_job_positionscode);
		}
