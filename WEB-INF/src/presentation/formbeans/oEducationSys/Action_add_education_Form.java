...
/**
 * This class is a FormBeanContainer for the action action_add_education.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_education_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setEducation_Form(Education_Form education_Form){
			...
			/**
			 * Shortcut to the personal code of the Education
			 * @return the code of the personal of the Education
			 */
			public String getPersonalcode(){
				return getEducation_Form().getEducation_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getEducation_Form().getEducation_personal().setPersonalcode(personalcode);
			}
