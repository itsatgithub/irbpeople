...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_external_job_sectors.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_external_job_sectors_Form extends FormBeanContainer {
	...
	//FormBean for the action
		 ...
		 * @param alumni_alumni_external_job_sectorscode the new code
		 */
		
		public void setAlumni_external_job_sectorscode(String alumni_alumni_external_job_sectorscode){
			
			getAlumni_external_job_sectors_Form().setAlumni_external_job_sectorscode(alumni_alumni_external_job_sectorscode);
		}
