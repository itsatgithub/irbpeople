...
/**
 * This class is a FormBeanContainer for the action action_modify_modify_page_alumni_params.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_modify_modify_page_alumni_params_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		/**
		 * @return returns the code of the current alumni_params_Form (a shortcut of getAlumni_params_Form().getAlumni_paramscode())
		 */
		...
		/**
		 * Sets the code of the current alumni_params_Form (a shortcut of getAlumni_params_Form().setAlumni_paramscode(String))
		 * @param alumni_alumni_paramscode the new code
		 */
		
		public void setAlumni_paramscode(String alumni_alumni_paramscode){
			
			getAlumni_params_Form().setAlumni_paramscode(alumni_alumni_paramscode);
		}
		 ...
		 * @param alumni_params_Form the new alumni_params_Form
		 */
