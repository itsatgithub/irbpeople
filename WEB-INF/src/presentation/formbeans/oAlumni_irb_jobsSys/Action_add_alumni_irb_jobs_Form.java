...
/**
 * This class is a FormBeanContainer for the action action_add_alumni_irb_jobs.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_alumni_irb_jobs_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		/**
		 * @return returns the code of the current alumni_irb_jobs_Form (a shortcut of getAlumni_irb_jobs_Form().getAlumni_irb_jobscode())
		 */
		...
		/**
		 * Sets the code of the current alumni_irb_jobs_Form (a shortcut of getAlumni_irb_jobs_Form().setAlumni_irb_jobscode(String))
		 * @param alumni_irb_jobscode the new code
		 */
		 ...
		 * @param alumni_irb_jobs_Form the new alumni_irb_jobs_Form
		 */
		...
		public void setAlumni_irb_jobs_Form(Alumni_irb_jobs_Form alumni_irb_jobs_Form){
			...
			/**
			 * Shortcut to the personal code of the Alumni_irb_jobs
			 * @return the code of the personal of the Alumni_irb_jobs
			 */
			public String getAlumni_personalcode(){
				return getAlumni_irb_jobs_Form().getPersonal().getAlumni_personalcode();
			}
			...
			public void setAlumni_personalcode(String personalcode){
				getAlumni_irb_jobs_Form().getPersonal().setAlumni_personalcode(personalcode);
			}
