...
/**
 * This class is a FormBeanContainer for the action action_add_holiday.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_holiday_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setHoliday_Form(Holiday_Form holiday_Form){
			...
			/**
			 * Shortcut to the personal code of the Holiday
			 * @return the code of the personal of the Holiday
			 */
			public String getPersonalcode(){
				return getHoliday_Form().getHoliday_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getHoliday_Form().getHoliday_personal().setPersonalcode(personalcode);
			}
