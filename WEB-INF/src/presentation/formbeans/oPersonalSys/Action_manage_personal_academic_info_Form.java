 ...
 * action_manage_personal_academic_info.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_manage_personal_academic_info_Form extends
		FormBeanContainer implements Personal_comments_container {
	...
	public BOAdderFormBean<Personal_comment_Form> getPersonal_comments() {
		if (personal_comments == null) {
			personal_comments = new BOAdderFormBean<Personal_comment_Form>(
					Personal_comment_Form.class);
		}
		return personal_comments;
	}

	public void setPersonal_comments(
			BOAdderFormBean<Personal_comment_Form> personal_comments) {
