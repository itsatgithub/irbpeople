...
/**
 * This class is a FormBeanContainer for the action action_new_page_funding_detail.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_new_page_funding_detail_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		public void setFunding_detail_Form(Funding_detail_Form funding_detail_Form){
			...
			/**
			 * Shortcut to the personal code of the funding_detail
			 * @return the code of the personal of the funding_detail
			 */
			public String getPersonalcode(){
				return getFunding_detail_Form().getFunding_detail_personal().getPersonalcode();
			}
			...
			public void setPersonalcode(String personalcode){
				getFunding_detail_Form().getFunding_detail_personal().setPersonalcode(personalcode);
			}
