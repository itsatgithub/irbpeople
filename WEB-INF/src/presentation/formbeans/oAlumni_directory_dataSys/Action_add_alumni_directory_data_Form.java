...
/**
 * This class is a FormBeanContainer for the action action_add_alumni_directory_data.
 * 
 * @author Automatika - JustInMind SL
 */
public class Action_add_alumni_directory_data_Form extends FormBeanContainer {
	...
	//FormBean for the action
		...
		/**
		 * @return returns the code of the current alumni_directory_data_Form (a shortcut of getAlumni_directory_data_Form().getAlumni_directory_datacode())
		 */
		...
		/**
		 * Sets the code of the current alumni_directory_data_Form (a shortcut of getAlumni_directory_data_Form().setAlumni_directory_datacode(String))
		 * @param alumni_directory_datacode the new code
		 */
		 ...
		 * @param alumni_directory_data_Form the new alumni_directory_data_Form
		 */
		...
		public void setAlumni_directory_data_Form(Alumni_directory_data_Form alumni_directory_data_Form){
			...
			/**
			 * Shortcut to the personal code of the Alumni_directory_data
			 * @return the code of the personal of the Alumni_directory_data
			 */
			public String getAlumni_personalcode(){
				return getAlumni_directory_data_Form().getPersonal().getAlumni_personalcode();
			}
			...
			public void setAlumni_personalcode(String personalcode){
				getAlumni_directory_data_Form().getPersonal().setAlumni_personalcode(personalcode);
			}
