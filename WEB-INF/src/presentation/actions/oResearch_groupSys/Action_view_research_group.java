...
import presentation.formbeans.oResearch_groupSys.Action_view_research_group_Form;
 ...
 *
 */
public class Action_view_research_group extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_view_research_group_Form action_view_research_group_Form = (Action_view_research_group_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_view_research_group_Form);

		/** 4.  We obtain the initial POJO. */

		Research_group research_group = UseCaseFacade.ObtainResearch_group(usercode, action_view_research_group_Form.getResearch_groupcode());
		...
		fbManager = new FormBeanManager(request, Action_view_research_group_Form.class);

		/** 6.2.  We add the current POJO merged with the nested-pojo-form-bean to the manager. */

		fbManager.setAttribute(research_group, "research_group_Form", Research_group_Form.class, action_view_research_group_Form.getResearch_group_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oResearch_groupSys__action_view_research_group_Form", fbManager.getContainer());
