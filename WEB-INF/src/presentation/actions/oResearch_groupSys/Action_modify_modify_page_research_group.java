 ...
 *
 */
public class Action_modify_modify_page_research_group extends Action {
...
Action_modify_modify_page_research_group_Form action_modify_modify_page_research_group_Form=(Action_modify_modify_page_research_group_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_research_group_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Research_group research_group = UseCaseFacade.UpdateResearch_group(usercode,(Research_group) fbManager.getPOJO("research_group_Form",Research_group.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "research_groupcode="+research_group.getResearch_groupcode(), isPopUp, research_group.getCode(), research_group.toString());
