...
import presentation.formbeans.oWork_experienceSys.Action_view_work_experience_Form;
 ...
 *
 */
public class Action_view_work_experience extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_view_work_experience_Form action_view_work_experience_Form = (Action_view_work_experience_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_view_work_experience_Form);

		/** 4.  We obtain the initial POJO. */

		Work_experience work_experience = UseCaseFacade.ObtainWork_experience(usercode, action_view_work_experience_Form.getWork_experiencecode());
		...
		fbManager = new FormBeanManager(request, Action_view_work_experience_Form.class);

		/** 6.2.  We add the current POJO merged with the nested-pojo-form-bean to the manager. */

		fbManager.setAttribute(work_experience, "work_experience_Form", Work_experience_Form.class, action_view_work_experience_Form.getWork_experience_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oWork_experienceSys__action_view_work_experience_Form", fbManager.getContainer());
