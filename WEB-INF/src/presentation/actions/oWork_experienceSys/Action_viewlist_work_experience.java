 ...
 *
 */
public class Action_viewlist_work_experience extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Work_experience>> _list_work_experience=UseCaseFacade.ObtainAllWork_experience(usercode,filter.obtainListConfigurator(locale, false));
