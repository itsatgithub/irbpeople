 ...
 *
 */
public class Action_delete_delete_page_work_experience extends Action {
...
Action_delete_delete_page_work_experience_Form action_delete_delete_page_work_experience_Form=(Action_delete_delete_page_work_experience_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_work_experience_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveWork_experience(usercode,action_delete_delete_page_work_experience_Form.getWork_experiencecode());	
