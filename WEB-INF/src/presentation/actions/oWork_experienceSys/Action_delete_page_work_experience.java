...
import presentation.formbeans.oWork_experienceSys.Action_delete_page_work_experience_Form;
 ...
 *
 */
public class Action_delete_page_work_experience extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_delete_page_work_experience_Form action_delete_page_work_experience_Form = (Action_delete_page_work_experience_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_work_experience_Form);

		/** 4.  We obtain the initial POJO. */

		Work_experience work_experience = UseCaseFacade.ObtainWork_experience(usercode, action_delete_page_work_experience_Form.getWork_experiencecode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_work_experience_Form.class);
		...
		fbManager.setAttribute(
				...
				action_delete_page_work_experience_Form.getWork_experience_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oWork_experienceSys__action_delete_page_work_experience_Form", fbManager.getContainer());
