 ...
 *
 */
public class Action_modify_modify_page_work_experience extends Action {
...
Action_modify_modify_page_work_experience_Form action_modify_modify_page_work_experience_Form=(Action_modify_modify_page_work_experience_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_work_experience_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Work_experience work_experience = UseCaseFacade.UpdateWork_experience(usercode,(Work_experience) fbManager.getPOJO("work_experience_Form",Work_experience.class));	
