 ...
 *
 */
public class Action_new_page_unit extends Action {
...
Action_new_page_unit_Form action_new_page_unit_Form=(Action_new_page_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_unit_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_unit_Form.class);
	...
	fbManager.setAttribute(unit, "unit_Form", Unit_Form.class, action_new_page_unit_Form.getUnit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oUnitSys__action_new_page_unit_Form", fbManager.getContainer());
