 ...
 *
 */
public class Action_new_new_page_unit extends Action {
...
Action_new_new_page_unit_Form action_new_new_page_unit_Form=(Action_new_new_page_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_unit_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Unit unit = UseCaseFacade.CreateUnit(usercode,(Unit) fbManager.getPOJO("unit_Form",Unit.class));	
