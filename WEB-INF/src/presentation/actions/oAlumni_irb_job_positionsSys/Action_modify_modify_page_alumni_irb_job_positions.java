 ...
 *
 */
public class Action_modify_modify_page_alumni_irb_job_positions extends Action {
...
Action_modify_modify_page_alumni_irb_job_positions_Form action_modify_modify_page_alumni_irb_job_positions_Form=(Action_modify_modify_page_alumni_irb_job_positions_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_alumni_irb_job_positions_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Alumni_irb_job_positions alumni_irb_job_positions = UseCaseFacade.UpdateAlumni_irb_job_positions(usercode,(Alumni_irb_job_positions) fbManager.getPOJO("alumni_irb_job_positions_Form",Alumni_irb_job_positions.class));	
