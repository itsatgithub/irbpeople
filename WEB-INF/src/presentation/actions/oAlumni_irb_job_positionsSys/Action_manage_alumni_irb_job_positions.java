 ...
 *
 */
public class Action_manage_alumni_irb_job_positions extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Alumni_irb_job_positions>> _list_alumni_irb_job_positions=UseCaseFacade.ObtainAllAlumni_irb_job_positions(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Alumni_irb_job_positions_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_alumni_irb_job_positions.getSecond(), locale, Alumni_irb_job_positions_Form.class);
