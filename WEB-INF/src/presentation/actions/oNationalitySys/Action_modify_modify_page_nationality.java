 ...
 *
 */
public class Action_modify_modify_page_nationality extends Action {
...
Action_modify_modify_page_nationality_Form action_modify_modify_page_nationality_Form=(Action_modify_modify_page_nationality_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_nationality_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Nationality nationality = UseCaseFacade.UpdateNationality(usercode,(Nationality) fbManager.getPOJO("nationality_Form",Nationality.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "nationalitycode="+nationality.getNationalitycode(), isPopUp, nationality.getCode(), nationality.toString());
