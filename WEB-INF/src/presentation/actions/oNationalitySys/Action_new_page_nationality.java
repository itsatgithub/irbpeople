 ...
 *
 */
public class Action_new_page_nationality extends Action {
...
Action_new_page_nationality_Form action_new_page_nationality_Form=(Action_new_page_nationality_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_nationality_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_nationality_Form.class);
	...
	fbManager.setAttribute(nationality, "nationality_Form", Nationality_Form.class, action_new_page_nationality_Form.getNationality_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oNationalitySys__action_new_page_nationality_Form", fbManager.getContainer());
