 ...
 *
 */
public class Action_manage_nationalities extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Nationality>> _list_nationality=UseCaseFacade.ObtainAllNationality(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Nationality_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_nationality.getSecond(), locale, Nationality_Form.class);
