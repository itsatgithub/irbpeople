 ...
 *
 */
public class Action_new_page_type_of_institution extends Action {
...
Action_new_page_type_of_institution_Form action_new_page_type_of_institution_Form=(Action_new_page_type_of_institution_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_institution_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_institution type_of_institution = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_institution_Form.class);
	...
	fbManager.setAttribute(type_of_institution, "type_of_institution_Form", Type_of_institution_Form.class, action_new_page_type_of_institution_Form.getType_of_institution_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_institutionSys__action_new_page_type_of_institution_Form", fbManager.getContainer());
