 ...
 *
 */
public class Action_manage_type_of_contract extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_contract>> _list_type_of_contract=UseCaseFacade.ObtainAllType_of_contract(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_contract_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_contract.getSecond(), locale, Type_of_contract_Form.class);
