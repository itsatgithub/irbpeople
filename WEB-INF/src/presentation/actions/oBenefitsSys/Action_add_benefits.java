...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oBenefitsSys.*;
 ...
 *
 */
public class Action_add_benefits extends Action {
...
Action_add_benefits_Form action_add_benefits_Form=(Action_add_benefits_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_benefits_Form);
...
fbManager=new FormBeanManager(request, Action_add_benefits_Form.class);
	...
	fbManager.setAttribute(benefits, "benefits_Form", Benefits_Form.class, action_add_benefits_Form.getBenefits_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oBenefitsSys__action_add_benefits_Form", fbManager.getContainer());
...
List<Type_of_benefit_Form> _selec_type_of_benefit_Form = ExtendedBeanUtils.copyPropertiesToFormBean(_selec_type_of_benefit.getSecond(), locale, Type_of_benefit_Form.class);
