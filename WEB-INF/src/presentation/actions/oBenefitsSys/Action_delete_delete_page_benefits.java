 ...
 *
 */
public class Action_delete_delete_page_benefits extends Action {
...
Action_delete_delete_page_benefits_Form action_delete_delete_page_benefits_Form=(Action_delete_delete_page_benefits_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_benefits_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveBenefits(usercode,action_delete_delete_page_benefits_Form.getBenefitscode());	
