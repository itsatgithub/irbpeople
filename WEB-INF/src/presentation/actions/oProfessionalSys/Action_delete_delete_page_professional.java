 ...
 *
 */
public class Action_delete_delete_page_professional extends Action {
...
Action_delete_delete_page_professional_Form action_delete_delete_page_professional_Form=(Action_delete_delete_page_professional_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_professional_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveProfessional(usercode,action_delete_delete_page_professional_Form.getProfessionalcode());	
