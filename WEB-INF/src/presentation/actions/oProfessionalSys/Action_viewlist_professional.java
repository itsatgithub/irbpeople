 ...
 *
 */
public class Action_viewlist_professional extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Professional>> _list_professional=UseCaseFacade.ObtainAllProfessional(usercode,filter.obtainListConfigurator(locale, false));
