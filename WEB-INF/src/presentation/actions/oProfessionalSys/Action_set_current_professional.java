 ...
 *
 */
public class Action_set_current_professional extends Action {
    ...
    throws Exception {                  
        ...
        String personalcode = UseCaseFacade.SetCurrentProfessional(usercode, action_delete_page_professional_Form.getProfessionalcode());
