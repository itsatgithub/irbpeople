 ...
 *
 */
public class Action_new_new_page_professional extends Action {
    ...
    throws Exception {    	    	    
        ...
        Action_new_new_page_professional_Form action_new_new_page_professional_Form=(Action_new_new_page_professional_Form) form;

        FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_professional_Form);	

        /** 3.  We use the business logic to create the new item */

        Professional professional = UseCaseFacade.CreateProfessional(usercode,(Professional) fbManager.getPOJO("professional_Form",Professional.class));	
...
//        request.setAttribute("professionalcode", professional.getCode());
//        request.setAttribute("newTitle", professional.toString());           
        
        return new ActionForward("/oProfessionalSys/popUp_action_mark_current_confirmation.do?professionalcode=" + professional.getCode() + "&isPopUpWindow=true", true);
