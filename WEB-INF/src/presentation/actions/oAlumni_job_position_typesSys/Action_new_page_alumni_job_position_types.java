 ...
 *
 */
public class Action_new_page_alumni_job_position_types extends Action {
...
Action_new_page_alumni_job_position_types_Form action_new_page_alumni_job_position_types_Form=(Action_new_page_alumni_job_position_types_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_alumni_job_position_types_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_job_position_types alumni_job_position_types = null;
...
fbManager=new FormBeanManager(request, Action_new_page_alumni_job_position_types_Form.class);
	...
	fbManager.setAttribute(alumni_job_position_types, "alumni_job_position_types_Form", Alumni_job_position_types_Form.class, action_new_page_alumni_job_position_types_Form.getAlumni_job_position_types_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_job_position_typesSys__action_new_page_alumni_job_position_types_Form", fbManager.getContainer());
