 ...
 *
 */
public class Action_delete_page_alumni_external_jobs extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Alumni_external_jobs alumni_external_jobs = UseCaseFacade.ObtainAlumni_external_jobs(usercode, action_delete_page_alumni_external_jobs_Form.getAlumni_external_jobscode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_alumni_external_jobs_Form.class);
		...
		request.setAttribute("oAlumni_external_jobsSys__action_delete_page_alumni_external_jobs_Form", fbManager.getContainer());
