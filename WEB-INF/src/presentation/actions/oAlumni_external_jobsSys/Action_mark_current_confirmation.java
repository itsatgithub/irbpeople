...
public class Action_mark_current_confirmation extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		FormBeanManager fbManager = new FormBeanManager(request,
				action_delete_page_alumni_external_jobs_Form);

		/** 4. We obtain the initial POJO. */

		Alumni_external_jobs alumni_external_jobs = UseCaseFacade.ObtainAlumni_external_jobs(
				usercode,
				action_delete_page_alumni_external_jobs_Form.getAlumni_external_jobscode());
		...
		fbManager = new FormBeanManager(request,
				Action_delete_page_alumni_external_jobs_Form.class);
		...
		fbManager.setAttribute(alumni_external_jobs, "alumni_external_jobs_Form",
				Alumni_external_jobs_Form.class,
				action_delete_page_alumni_external_jobs_Form.getAlumni_external_jobs_Form());

		/** 6.3. We add the container of the manager to the request. */

		request.setAttribute(
				"oAlumni_external_jobsSys__action_delete_page_alumni_external_jobs_Form",
