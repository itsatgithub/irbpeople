 ...
 *
 */
public class Action_manage_working_hours extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Working_hours>> _list_working_hours=UseCaseFacade.ObtainAllWorking_hours(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Working_hours_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_working_hours.getSecond(), locale, Working_hours_Form.class);
