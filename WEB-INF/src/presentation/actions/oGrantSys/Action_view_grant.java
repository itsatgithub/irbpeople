 ...
 *
 */
public class Action_view_grant extends Action {
...
Action_view_grant_Form action_view_grant_Form=(Action_view_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_grant_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Grant grant = UseCaseFacade.ObtainGrant(usercode, action_view_grant_Form.getGrantcode());
...
fbManager=new FormBeanManager(request, Action_view_grant_Form.class);
	...
	fbManager.setAttribute(grant, "grant_Form", Grant_Form.class, action_view_grant_Form.getGrant_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oGrantSys__action_view_grant_Form", fbManager.getContainer());
