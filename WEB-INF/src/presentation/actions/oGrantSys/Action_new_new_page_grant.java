 ...
 *
 */
public class Action_new_new_page_grant extends Action {
...
Action_new_new_page_grant_Form action_new_new_page_grant_Form=(Action_new_new_page_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_grant_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Grant grant = UseCaseFacade.CreateGrant(usercode,(Grant) fbManager.getPOJO("grant_Form",Grant.class));	
