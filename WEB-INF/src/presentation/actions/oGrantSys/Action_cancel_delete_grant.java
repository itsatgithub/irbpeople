 ...
 *
 */
public class Action_cancel_delete_grant extends Action {
...
Action_cancel_delete_grant_Form action_cancel_delete_grant_Form=(Action_cancel_delete_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_cancel_delete_grant_Form);			
