 ...
 *
 */
public class Action_manage_grants extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Grant>> _list_grant=UseCaseFacade.ObtainAllGrant(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Grant_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_grant.getSecond(), locale, Grant_Form.class);
