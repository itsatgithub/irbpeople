 ...
 *
 */
public class Action_new_page_grant extends Action {
...
Action_new_page_grant_Form action_new_page_grant_Form=(Action_new_page_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_grant_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_grant_Form.class);
	...
	fbManager.setAttribute(grant, "grant_Form", Grant_Form.class, action_new_page_grant_Form.getGrant_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oGrantSys__action_new_page_grant_Form", fbManager.getContainer());
