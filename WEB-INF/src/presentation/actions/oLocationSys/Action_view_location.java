 ...
 *
 */
public class Action_view_location extends Action {
...
Action_view_location_Form action_view_location_Form=(Action_view_location_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_location_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Location location = UseCaseFacade.ObtainLocation(usercode, action_view_location_Form.getLocationcode());
...
fbManager=new FormBeanManager(request, Action_view_location_Form.class);
	...
	fbManager.setAttribute(location, "location_Form", Location_Form.class, action_view_location_Form.getLocation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oLocationSys__action_view_location_Form", fbManager.getContainer());
