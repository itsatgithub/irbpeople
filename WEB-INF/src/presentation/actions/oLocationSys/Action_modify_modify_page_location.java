 ...
 *
 */
public class Action_modify_modify_page_location extends Action {
...
Action_modify_modify_page_location_Form action_modify_modify_page_location_Form=(Action_modify_modify_page_location_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_location_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Location location = UseCaseFacade.UpdateLocation(usercode,(Location) fbManager.getPOJO("location_Form",Location.class));	
	UseCaseFacade.updateLocationCode(usercode, location.getCode(), action_modify_modify_page_location_Form.getLocation_Form().getNewLocationcode());
...
return NavigationFunctions.findForward(request, mapping, "success", "locationcode="+location.getLocationcode(), isPopUp, location.getCode(), location.toString());
