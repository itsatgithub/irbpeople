package presentation.actions.oType_of_holidaysSys;
...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oType_of_holidaysSys.*;
 ...
 *
 */
public class Action_delete_page_type_of_holidays extends Action {
...
Action_delete_page_type_of_holidays_Form action_delete_page_type_of_holidays_Form=(Action_delete_page_type_of_holidays_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_type_of_holidays_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_holidays type_of_holidays = UseCaseFacade.ObtainType_of_holidays(usercode, action_delete_page_type_of_holidays_Form.getType_of_holidayscode());
...
fbManager=new FormBeanManager(request, Action_delete_page_type_of_holidays_Form.class);
	...
	fbManager.setAttribute(type_of_holidays, "type_of_holidays_Form", Type_of_holidays_Form.class, action_delete_page_type_of_holidays_Form.getType_of_holidays_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_holidaysSys__action_delete_page_type_of_holidays_Form", fbManager.getContainer());
