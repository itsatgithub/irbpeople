...
import presentation.formbeans.oCalendarSys.Action_delete_delete_calendar_Form;
 ...
 *
 */
public class Action_delete_delete_calendar extends Action {
    ...
    Action_delete_delete_calendar_Form action_delete_delete_calendar_Form=(Action_delete_delete_calendar_Form) form;

    FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_calendar_Form);
    
    try
    {
        Irbholiday irbholiday = UseCaseFacade.DeleteIrbholiday(usercode, action_delete_delete_calendar_Form.getIrbholidaycode());
