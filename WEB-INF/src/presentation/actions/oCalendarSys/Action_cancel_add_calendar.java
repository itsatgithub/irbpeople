 ...
 *
 */
public class Action_cancel_add_calendar extends Action {
    ...
    Action_cancel_add_calendar_Form action_cancel_add_calendar_Form=(Action_cancel_add_calendar_Form) form;

    FormBeanManager fbManager=new FormBeanManager(request, action_cancel_add_calendar_Form);
