 ...
 *
 */
public class Action_modify_modify_event extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_modify_modify_event_Form action_modify_modify_event_Form = (Action_modify_modify_event_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_modify_modify_event_Form);
