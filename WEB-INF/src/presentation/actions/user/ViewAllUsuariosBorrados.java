...
public class ViewAllUsuariosBorrados extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
	    ...
	    //use case execution
    	Pair<Integer,List<Usuario>> usuarios = UseCaseFacade.ObtenerUsuariosBorrados(usercode, filter.obtainListConfigurator(locale, true));         	        	
