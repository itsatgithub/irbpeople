...
public class DoDeactivateUsuario extends Action {
            ...
            HttpServletResponse response) throws Exception
    {
    	...
    	//Use case execution
        Usuario usuario = UseCaseFacade.DesactivarUsuario(usercode, usuarioForm.getUsuariocode());
    	...
    	messages.add("info.usuario-desactivado", new ActionMessage("info.usuario-desactivado"));
    	errors.add(messages);
