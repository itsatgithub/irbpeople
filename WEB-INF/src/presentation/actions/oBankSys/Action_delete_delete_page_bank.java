 ...
 *
 */
public class Action_delete_delete_page_bank extends Action {
...
Action_delete_delete_page_bank_Form action_delete_delete_page_bank_Form=(Action_delete_delete_page_bank_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_bank_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveBank(usercode,action_delete_delete_page_bank_Form.getBankcode());	
