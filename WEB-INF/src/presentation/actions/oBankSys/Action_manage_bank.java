 ...
 *
 */
public class Action_manage_bank extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Bank>> _list_bank=UseCaseFacade.ObtainAllBank(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Bank_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_bank.getSecond(), locale, Bank_Form.class);
