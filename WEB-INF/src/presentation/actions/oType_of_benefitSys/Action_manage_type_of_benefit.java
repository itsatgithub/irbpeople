 ...
 *
 */
public class Action_manage_type_of_benefit extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_benefit>> _list_type_of_benefit=UseCaseFacade.ObtainAllType_of_benefit(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_benefit_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_benefit.getSecond(), locale, Type_of_benefit_Form.class);
