 ...
 *
 */
public class Action_manage_type_of_study extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Type_of_study>> _list_type_of_study=UseCaseFacade.ObtainAllType_of_study(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Type_of_study_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_type_of_study.getSecond(), locale, Type_of_study_Form.class);
