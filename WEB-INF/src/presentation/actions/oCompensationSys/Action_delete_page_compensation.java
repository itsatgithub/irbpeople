 ...
 *
 */
public class Action_delete_page_compensation extends Action {
...
FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_compensation_Form);
	...
	Compensation compensation = UseCaseFacade.ObtainCompensation(usercode, action_delete_page_compensation_Form.getCompensationcode());
...
fbManager=new FormBeanManager(request, Action_delete_page_compensation_Form.class);
	...
	fbManager.setAttribute(compensation, "compensation_Form", Compensation_Form.class, action_delete_page_compensation_Form.getCompensation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oCompensationSys__action_delete_page_compensation_Form", fbManager.getContainer());
