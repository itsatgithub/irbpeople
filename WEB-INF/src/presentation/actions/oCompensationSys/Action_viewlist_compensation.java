 ...
 *
 */
public class Action_viewlist_compensation extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Compensation>> _list_compensation=UseCaseFacade.ObtainAllCompensation(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Compensation_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_compensation.getSecond(), locale, Compensation_Form.class);
