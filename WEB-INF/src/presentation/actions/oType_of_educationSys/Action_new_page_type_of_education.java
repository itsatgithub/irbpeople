 ...
 *
 */
public class Action_new_page_type_of_education extends Action {
...
Action_new_page_type_of_education_Form action_new_page_type_of_education_Form=(Action_new_page_type_of_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_education_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_education type_of_education = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_education_Form.class);
	...
	fbManager.setAttribute(type_of_education, "type_of_education_Form", Type_of_education_Form.class, action_new_page_type_of_education_Form.getType_of_education_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_educationSys__action_new_page_type_of_education_Form", fbManager.getContainer());
