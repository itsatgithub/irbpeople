 ...
 *
 */
public class Action_new_page_payment extends Action {
...
Action_new_page_payment_Form action_new_page_payment_Form=(Action_new_page_payment_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_payment_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_payment_Form.class);
	...
	fbManager.setAttribute(payment, "payment_Form", Payment_Form.class, action_new_page_payment_Form.getPayment_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPaymentSys__action_new_page_payment_Form", fbManager.getContainer());
