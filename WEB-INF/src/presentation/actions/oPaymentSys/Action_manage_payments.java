 ...
 *
 */
public class Action_manage_payments extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Payment>> _list_payment=UseCaseFacade.ObtainAllPayment(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Payment_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_payment.getSecond(), locale, Payment_Form.class);
