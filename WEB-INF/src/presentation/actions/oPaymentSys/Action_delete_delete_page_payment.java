 ...
 *
 */
public class Action_delete_delete_page_payment extends Action {
...
Action_delete_delete_page_payment_Form action_delete_delete_page_payment_Form=(Action_delete_delete_page_payment_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_payment_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemovePayment(usercode,action_delete_delete_page_payment_Form.getPaymentcode());	
