 ...
 *
 */
public class Action_modify_modify_page_payment extends Action {
...
Action_modify_modify_page_payment_Form action_modify_modify_page_payment_Form=(Action_modify_modify_page_payment_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_payment_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Payment payment = UseCaseFacade.UpdatePayment(usercode,(Payment) fbManager.getPOJO("payment_Form",Payment.class));	
