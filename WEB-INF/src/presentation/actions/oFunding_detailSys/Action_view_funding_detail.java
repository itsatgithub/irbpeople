...
import presentation.formbeans.oFunding_detailSys.Action_view_funding_detail_Form;
 ...
 *
 */
public class Action_view_funding_detail extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_view_funding_detail_Form action_view_funding_detail_Form = (Action_view_funding_detail_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_view_funding_detail_Form);

		/** 4.  We obtain the initial POJO. */

		Funding_detail funding_detail = UseCaseFacade.ObtainFunding_detail(usercode, action_view_funding_detail_Form.getFunding_detailcode());
		...
		fbManager = new FormBeanManager(request, Action_view_funding_detail_Form.class);

		/** 6.2.  We add the current POJO merged with the nested-pojo-form-bean to the manager. */

		fbManager.setAttribute(funding_detail, "funding_detail_Form", Funding_detail_Form.class, action_view_funding_detail_Form.getFunding_detail_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oFunding_detailSys__action_view_funding_detail_Form", fbManager.getContainer());
