...
import presentation.formbeans.oFunding_detailSys.*;
 ...
 *
 */
public class Action_new_page_funding_detail extends Action {
...
Action_new_page_funding_detail_Form action_new_page_funding_detail_Form=(Action_new_page_funding_detail_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_funding_detail_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Funding_detail funding_detail = null;
...
fbManager=new FormBeanManager(request, Action_new_page_funding_detail_Form.class);
	...
	fbManager.setAttribute(funding_detail, "funding_detail_Form", Funding_detail_Form.class, action_new_page_funding_detail_Form.getFunding_detail_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oFunding_detailSys__action_new_page_funding_detail_Form", fbManager.getContainer());
