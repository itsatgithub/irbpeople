 ...
 *
 */
public class Action_viewlist_funding_detail extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Funding_detail>> _list_funding_detail=UseCaseFacade.ObtainAllFunding_detail(usercode,filter.obtainListConfigurator(locale, false));
