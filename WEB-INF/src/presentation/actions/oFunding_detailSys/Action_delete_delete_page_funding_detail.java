 ...
 *
 */
public class Action_delete_delete_page_funding_detail extends Action {
...
Action_delete_delete_page_funding_detail_Form action_delete_delete_page_funding_detail_Form=(Action_delete_delete_page_funding_detail_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_funding_detail_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveFunding_detail(usercode,action_delete_delete_page_funding_detail_Form.getFunding_detailcode());	
