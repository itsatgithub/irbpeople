 ...
 *
 */
public class Action_modify_modify_page_country extends Action {
...
Action_modify_modify_page_country_Form action_modify_modify_page_country_Form=(Action_modify_modify_page_country_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_country_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Country country = UseCaseFacade.UpdateCountry(usercode,(Country) fbManager.getPOJO("country_Form",Country.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "countrycode="+country.getCountrycode(), isPopUp, country.getCode(), country.toString());
