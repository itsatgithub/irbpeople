 ...
 *
 */
public class Action_new_new_page_country extends Action {
...
Action_new_new_page_country_Form action_new_new_page_country_Form=(Action_new_new_page_country_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_country_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Country country = UseCaseFacade.CreateCountry(usercode,(Country) fbManager.getPOJO("country_Form",Country.class));	
