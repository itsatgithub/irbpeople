 ...
 *
 */
public class Action_view_country extends Action {
...
Action_view_country_Form action_view_country_Form=(Action_view_country_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_country_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Country country = UseCaseFacade.ObtainCountry(usercode, action_view_country_Form.getCountrycode());
...
fbManager=new FormBeanManager(request, Action_view_country_Form.class);
	...
	fbManager.setAttribute(country, "country_Form", Country_Form.class, action_view_country_Form.getCountry_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oCountrySys__action_view_country_Form", fbManager.getContainer());
