 ...
 *
 */
public class Action_new_new_page_area extends Action {
...
Action_new_new_page_area_Form action_new_new_page_area_Form=(Action_new_new_page_area_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_area_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Area area = UseCaseFacade.CreateArea(usercode,(Area) fbManager.getPOJO("area_Form",Area.class));	
