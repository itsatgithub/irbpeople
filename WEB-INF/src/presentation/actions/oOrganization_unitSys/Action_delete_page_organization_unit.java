 ...
 *
 */
public class Action_delete_page_organization_unit extends Action {
...
Action_delete_page_organization_unit_Form action_delete_page_organization_unit_Form=(Action_delete_page_organization_unit_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_organization_unit_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Organization_unit organization_unit = UseCaseFacade.ObtainOrganization_unit(usercode, action_delete_page_organization_unit_Form.getOrganization_unitcode());
...
fbManager=new FormBeanManager(request, Action_delete_page_organization_unit_Form.class);
	...
	fbManager.setAttribute(organization_unit, "organization_unit_Form", Organization_unit_Form.class, action_delete_page_organization_unit_Form.getOrganization_unit_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oOrganization_unitSys__action_delete_page_organization_unit_Form", fbManager.getContainer());
