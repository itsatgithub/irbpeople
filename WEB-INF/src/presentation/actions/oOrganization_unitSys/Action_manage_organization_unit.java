 ...
 *
 */
public class Action_manage_organization_unit extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Organization_unit>> _list_organization_unit=UseCaseFacade.ObtainAllOrganization_unit(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Organization_unit_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_organization_unit.getSecond(), locale, Organization_unit_Form.class);
