 ...
 *
 */
public class Action_new_page_type_of_compensation extends Action {
...
Action_new_page_type_of_compensation_Form action_new_page_type_of_compensation_Form=(Action_new_page_type_of_compensation_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_type_of_compensation_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_compensation type_of_compensation = null;
...
fbManager=new FormBeanManager(request, Action_new_page_type_of_compensation_Form.class);
	...
	fbManager.setAttribute(type_of_compensation, "type_of_compensation_Form", Type_of_compensation_Form.class, action_new_page_type_of_compensation_Form.getType_of_compensation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_compensationSys__action_new_page_type_of_compensation_Form", fbManager.getContainer());
