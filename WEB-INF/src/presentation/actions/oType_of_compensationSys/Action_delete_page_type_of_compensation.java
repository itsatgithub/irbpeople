package presentation.actions.oType_of_compensationSys;
...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oType_of_compensationSys.*;
 ...
 *
 */
public class Action_delete_page_type_of_compensation extends Action {
...
Action_delete_page_type_of_compensation_Form action_delete_page_type_of_compensation_Form=(Action_delete_page_type_of_compensation_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_type_of_compensation_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_compensation type_of_compensation = UseCaseFacade.ObtainType_of_compensation(usercode, action_delete_page_type_of_compensation_Form.getType_of_compensationcode());
...
fbManager=new FormBeanManager(request, Action_delete_page_type_of_compensation_Form.class);
	...
	fbManager.setAttribute(type_of_compensation, "type_of_compensation_Form", Type_of_compensation_Form.class, action_delete_page_type_of_compensation_Form.getType_of_compensation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_compensationSys__action_delete_page_type_of_compensation_Form", fbManager.getContainer());
