 ...
 *
 */
public class Action_delete_delete_page_alumni_titles extends Action {
...
Action_delete_delete_page_alumni_titles_Form action_delete_delete_page_alumni_titles_Form=(Action_delete_delete_page_alumni_titles_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_alumni_titles_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveAlumni_titles(usercode,action_delete_delete_page_alumni_titles_Form.getAlumni_titlescode());	
