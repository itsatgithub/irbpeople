 ...
 *
 */
public class Action_manage_alumni_titles extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Alumni_titles>> _list_alumni_titles=UseCaseFacade.ObtainAllAlumni_titles(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Alumni_titles_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_alumni_titles.getSecond(), locale, Alumni_titles_Form.class);
