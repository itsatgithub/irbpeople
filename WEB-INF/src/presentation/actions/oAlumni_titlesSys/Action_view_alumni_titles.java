 ...
 *
 */
public class Action_view_alumni_titles extends Action {
...
Action_view_alumni_titles_Form action_view_alumni_titles_Form=(Action_view_alumni_titles_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_alumni_titles_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_titles alumni_titles = UseCaseFacade.ObtainAlumni_titles(usercode, action_view_alumni_titles_Form.getAlumni_titlescode());
...
fbManager=new FormBeanManager(request, Action_view_alumni_titles_Form.class);
	...
	fbManager.setAttribute(alumni_titles, "alumni_titles_Form", Alumni_titles_Form.class, action_view_alumni_titles_Form.getAlumni_titles_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_titlesSys__action_view_alumni_titles_Form", fbManager.getContainer());
