...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oHolidaySys.*;
 ...
 *
 */
public class Action_add_holiday extends Action {
...
Action_add_holiday_Form action_add_holiday_Form=(Action_add_holiday_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_holiday_Form);
...
fbManager=new FormBeanManager(request, Action_add_holiday_Form.class);
	...
	fbManager.setAttribute(holiday, "holiday_Form", Holiday_Form.class, action_add_holiday_Form.getHoliday_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oHolidaySys__action_add_holiday_Form", fbManager.getContainer());
...
List<Type_of_holidays_Form> _selec_type_of_holidays_Form = ExtendedBeanUtils.copyPropertiesToFormBean(_selec_type_of_holidays.getSecond(), locale, Type_of_holidays_Form.class);
