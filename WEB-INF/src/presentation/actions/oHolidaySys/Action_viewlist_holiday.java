 ...
 *
 */
public class Action_viewlist_holiday extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Holiday>> _list_holiday=UseCaseFacade.ObtainAllHoliday(usercode,filter.obtainListConfigurator(locale, false));
