 ...
 *
 */
public class Action_delete_delete_page_holiday extends Action {
...
Action_delete_delete_page_holiday_Form action_delete_delete_page_holiday_Form=(Action_delete_delete_page_holiday_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_holiday_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveHoliday(usercode,action_delete_delete_page_holiday_Form.getHolidaycode());	
