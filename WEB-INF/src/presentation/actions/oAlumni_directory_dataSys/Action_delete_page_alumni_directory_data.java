...
import presentation.formbeans.oAlumni_directory_dataSys.Action_delete_page_alumni_directory_data_Form;
 ...
 *
 */
public class Action_delete_page_alumni_directory_data extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Action_delete_page_alumni_directory_data_Form action_delete_page_alumni_directory_data_Form = (Action_delete_page_alumni_directory_data_Form) form;

		FormBeanManager fbManager = new FormBeanManager(request, action_delete_page_alumni_directory_data_Form);

		/** 4.  We obtain the initial POJO. */

		Alumni_directory_data alumni_directory_data = UseCaseFacade.ObtainAlumni_directory_data(usercode, action_delete_page_alumni_directory_data_Form.getAlumni_directory_datacode());
		...
		fbManager = new FormBeanManager(request, Action_delete_page_alumni_directory_data_Form.class);

		/** 6.2.  We add the current POJO merged with the nested-pojo-form-bean to the manager. */

		fbManager.setAttribute(
				alumni_directory_data,
				"alumni_directory_data_Form",
				Alumni_directory_data_Form.class,
				action_delete_page_alumni_directory_data_Form.getAlumni_directory_data_Form());

		/** 6.3.  We add the container of the manager to the request. */

		request.setAttribute("oAlumni_directory_dataSys__action_delete_page_alumni_directory_data_Form", fbManager.getContainer());
