 ...
 *
 */
public class Action_manage_validated_alumni_personal extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Pair<Integer, Pair<List<Alumni_personal>, Map<String, String[]>>> _list_alumni_personal =
				UseCaseFacade.ObtainValidatedAlumni_personalAndOrderMap(usercode, filter.obtainListConfigurator(locale, true));
