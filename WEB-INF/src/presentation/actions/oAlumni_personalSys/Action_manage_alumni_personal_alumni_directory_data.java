...
import presentation.formbeans.oAlumni_personalSys.Action_manage_alumni_personal_alumni_directory_data_Form;
 ...
 * 
 */
public class Action_manage_alumni_personal_alumni_directory_data extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Action_manage_alumni_personal_alumni_directory_data_Form action_manage_alumni_personal_alumni_directory_data_Form = (Action_manage_alumni_personal_alumni_directory_data_Form) form;

        FormBeanManager fbManager = new FormBeanManager(request, action_manage_alumni_personal_alumni_directory_data_Form);

        /** 4. We obtain the initial POJO. */

        Alumni_personal alumni_personal = UseCaseFacade.ObtainAlumni_personal(usercode, action_manage_alumni_personal_alumni_directory_data_Form
        ...
        fbManager = new FormBeanManager(request, Action_manage_alumni_personal_alumni_directory_data_Form.class);
        ...
        fbManager.setAttribute(alumni_personal, "alumni_personal_Form", Alumni_personal_Form.class,
                action_manage_alumni_personal_alumni_directory_data_Form.getAlumni_personal_Form());

        /** 6.3. We add the container of the manager to the request. */

        request.setAttribute("oAlumni_personalSys__action_manage_alumni_personal_alumni_directory_data_Form", fbManager.getContainer());
        ...
        Pair<Integer, List<Alumni_directory_data>> _list_alumni_directory_data = UseCaseFacade
                .ObtainAllIalumni_directory_data_alumni_personalFromPersonal(usercode,
                        action_manage_alumni_personal_alumni_directory_data_Form.getAlumni_personal_Form().getAlumni_personalcode(), filter
                                .obtainListConfigurator(locale, false));

        /** 6.5.3. We obtain copy the list of pojos to a list of FormBeans */

        List<Alumni_directory_data_Form> viewlistElements = ExtendedBeanUtils.copyPropertiesToFormBean(
                _list_alumni_directory_data.getSecond(), locale, Alumni_directory_data_Form.class);
