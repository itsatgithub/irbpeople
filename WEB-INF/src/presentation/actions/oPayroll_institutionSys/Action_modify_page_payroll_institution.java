 ...
 *
 */
public class Action_modify_page_payroll_institution extends Action {
...
Action_modify_page_payroll_institution_Form action_modify_page_payroll_institution_Form=(Action_modify_page_payroll_institution_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_payroll_institution_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Payroll_institution payroll_institution = UseCaseFacade.ObtainPayroll_institution(usercode, action_modify_page_payroll_institution_Form.getPayroll_institutioncode());
...
fbManager=new FormBeanManager(request, Action_modify_page_payroll_institution_Form.class);
	...
	fbManager.setAttribute(payroll_institution, "payroll_institution_Form", Payroll_institution_Form.class, action_modify_page_payroll_institution_Form.getPayroll_institution_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPayroll_institutionSys__action_modify_page_payroll_institution_Form", fbManager.getContainer());
