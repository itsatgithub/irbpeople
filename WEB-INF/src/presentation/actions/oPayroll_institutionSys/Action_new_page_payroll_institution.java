 ...
 *
 */
public class Action_new_page_payroll_institution extends Action {
...
Action_new_page_payroll_institution_Form action_new_page_payroll_institution_Form=(Action_new_page_payroll_institution_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_payroll_institution_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Payroll_institution payroll_institution = null;
...
fbManager=new FormBeanManager(request, Action_new_page_payroll_institution_Form.class);
	...
	fbManager.setAttribute(payroll_institution, "payroll_institution_Form", Payroll_institution_Form.class, action_new_page_payroll_institution_Form.getPayroll_institution_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPayroll_institutionSys__action_new_page_payroll_institution_Form", fbManager.getContainer());
