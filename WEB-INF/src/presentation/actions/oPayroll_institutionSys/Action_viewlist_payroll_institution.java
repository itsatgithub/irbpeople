 ...
 *
 */
public class Action_viewlist_payroll_institution extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Payroll_institution>> _list_payroll_institution=UseCaseFacade.ObtainAllPayroll_institution(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Payroll_institution_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_payroll_institution.getSecond(), locale, Payroll_institution_Form.class);
