 ...
 *
 */
public class Action_delete_delete_page_type_of_grant extends Action {
...
Action_delete_delete_page_type_of_grant_Form action_delete_delete_page_type_of_grant_Form=(Action_delete_delete_page_type_of_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_type_of_grant_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveType_of_grant(usercode,action_delete_delete_page_type_of_grant_Form.getType_of_grantcode());	
