 ...
 *
 */
public class Action_view_type_of_grant extends Action {
...
Action_view_type_of_grant_Form action_view_type_of_grant_Form=(Action_view_type_of_grant_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_type_of_grant_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Type_of_grant type_of_grant = UseCaseFacade.ObtainType_of_grant(usercode, action_view_type_of_grant_Form.getType_of_grantcode());
...
fbManager=new FormBeanManager(request, Action_view_type_of_grant_Form.class);
	...
	fbManager.setAttribute(type_of_grant, "type_of_grant_Form", Type_of_grant_Form.class, action_view_type_of_grant_Form.getType_of_grant_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oType_of_grantSys__action_view_type_of_grant_Form", fbManager.getContainer());
