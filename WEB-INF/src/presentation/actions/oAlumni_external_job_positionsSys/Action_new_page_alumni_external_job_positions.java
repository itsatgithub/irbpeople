 ...
 *
 */
public class Action_new_page_alumni_external_job_positions extends Action {
...
Action_new_page_alumni_external_job_positions_Form action_new_page_alumni_external_job_positions_Form=(Action_new_page_alumni_external_job_positions_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_alumni_external_job_positions_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_external_job_positions alumni_external_job_positions = null;
...
fbManager=new FormBeanManager(request, Action_new_page_alumni_external_job_positions_Form.class);
	...
	fbManager.setAttribute(alumni_external_job_positions, "alumni_external_job_positions_Form", Alumni_external_job_positions_Form.class, action_new_page_alumni_external_job_positions_Form.getAlumni_external_job_positions_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_external_job_positionsSys__action_new_page_alumni_external_job_positions_Form", fbManager.getContainer());
