 ...
 *
 */
public class Action_delete_delete_page_alumni_external_job_positions extends Action {
...
Action_delete_delete_page_alumni_external_job_positions_Form action_delete_delete_page_alumni_external_job_positions_Form=(Action_delete_delete_page_alumni_external_job_positions_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_alumni_external_job_positions_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveAlumni_external_job_positions(usercode,action_delete_delete_page_alumni_external_job_positions_Form.getAlumni_external_job_positionscode());	
