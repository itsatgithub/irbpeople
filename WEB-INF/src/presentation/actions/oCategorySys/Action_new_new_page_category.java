 ...
 *
 */
public class Action_new_new_page_category extends Action {
...
Action_new_new_page_category_Form action_new_new_page_category_Form=(Action_new_new_page_category_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_category_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Category category = UseCaseFacade.CreateCategory(usercode,(Category) fbManager.getPOJO("category_Form",Category.class));	
