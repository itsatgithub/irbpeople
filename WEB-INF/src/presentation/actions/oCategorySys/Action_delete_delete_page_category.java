 ...
 *
 */
public class Action_delete_delete_page_category extends Action {
...
Action_delete_delete_page_category_Form action_delete_delete_page_category_Form=(Action_delete_delete_page_category_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_category_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveCategory(usercode,action_delete_delete_page_category_Form.getCategorycode());	
