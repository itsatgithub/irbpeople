 ...
 *
 */
public class Action_manage_category extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Category>> _list_category=UseCaseFacade.ObtainAllCategory(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Category_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_category.getSecond(), locale, Category_Form.class);
