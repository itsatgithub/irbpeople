 ...
 *
 */
public class Action_new_page_category extends Action {
...
Action_new_page_category_Form action_new_page_category_Form=(Action_new_page_category_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_category_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_category_Form.class);
	...
	fbManager.setAttribute(category, "category_Form", Category_Form.class, action_new_page_category_Form.getCategory_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oCategorySys__action_new_page_category_Form", fbManager.getContainer());
