 ...
 *
 */
public class Action_view_category extends Action {
...
Action_view_category_Form action_view_category_Form=(Action_view_category_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_category_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Category category = UseCaseFacade.ObtainCategory(usercode, action_view_category_Form.getCategorycode());
...
fbManager=new FormBeanManager(request, Action_view_category_Form.class);
	...
	fbManager.setAttribute(category, "category_Form", Category_Form.class, action_view_category_Form.getCategory_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oCategorySys__action_view_category_Form", fbManager.getContainer());
