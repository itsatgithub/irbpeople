 ...
 *
 */
public class Action_add_my_own_education extends Action {
...
Action_add_my_own_education_Form action_add_my_own_education_Form=(Action_add_my_own_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_add_my_own_education_Form);
...
fbManager=new FormBeanManager(request, Action_add_my_own_education_Form.class);
	...
	fbManager.setAttribute(education, "education_Form", Education_Form.class, action_add_my_own_education_Form.getEducation_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oEducationSys__action_add_my_own_education_Form", fbManager.getContainer());
