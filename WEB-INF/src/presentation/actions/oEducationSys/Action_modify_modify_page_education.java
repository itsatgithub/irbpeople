 ...
 *
 */
public class Action_modify_modify_page_education extends Action {
...
Action_modify_modify_page_education_Form action_modify_modify_page_education_Form=(Action_modify_modify_page_education_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_education_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Education education = UseCaseFacade.UpdateEducation(usercode,(Education) fbManager.getPOJO("education_Form",Education.class));	
