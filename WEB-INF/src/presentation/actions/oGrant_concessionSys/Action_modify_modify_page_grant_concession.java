 ...
 *
 */
public class Action_modify_modify_page_grant_concession extends Action {
...
Action_modify_modify_page_grant_concession_Form action_modify_modify_page_grant_concession_Form=(Action_modify_modify_page_grant_concession_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_grant_concession_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Grant_concession grant_concession = UseCaseFacade.UpdateGrant_concession(usercode,(Grant_concession) fbManager.getPOJO("grant_concession_Form",Grant_concession.class));	
