 ...
 *
 */
public class Action_todelete_choose_current_personal extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Personal>> _list_personal=UseCaseFacade.ObtainAllPersonal(usercode,filter.obtainListConfigurator(locale, false));
