 ...
 *
 */
public class Action_modify_my_own_personal_modify_modify_page_personal extends Action {
...
Action_modify_my_own_personal_modify_modify_page_personal_Form action_modify_my_own_personal_modify_modify_page_personal_Form=(Action_modify_my_own_personal_modify_modify_page_personal_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_my_own_personal_modify_modify_page_personal_Form);			
	...
	if((professionalDTO.getCode()==null || professionalDTO.getCode().equals(""))){
		professionalDTO.setProfessional_personal(personal);
		UseCaseFacade.CreateProfessional(usercode, professionalDTO);
	}
	else if (professionalDTO.getCode()!=null && !professionalDTO.getCode().equals("")){
...
//	/**Image**/
//	FormFile imageFile=action_modify_my_own_personal_modify_modify_page_personal_Form.getPersonalPhoto_Form().getPhoto();
//	
//	if(imageFile.getFileSize()>1024*1024){
//		NavigationFunctions.putAtionError(request, mapping, "errors.imageToBig");
...
//		UseCaseFacade.setPersonalPhotoToPersonal(usercode, photo, personal.getCode());
//	}
