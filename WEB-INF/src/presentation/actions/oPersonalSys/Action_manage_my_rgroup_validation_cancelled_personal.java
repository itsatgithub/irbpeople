 ...
 *
 */
public class Action_manage_my_rgroup_validation_cancelled_personal extends Action {
	...
	filter=FilteringFunctions.addPersonalStateFilter(filter, Personalstate.VALIDATING_CANCELLED_CODE);
