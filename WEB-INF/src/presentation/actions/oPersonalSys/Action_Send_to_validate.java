 ...
 *
 */
public class Action_Send_to_validate extends Action {
...
Action_Send_to_validate_Form action_Send_to_validate_Form=(Action_Send_to_validate_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_Send_to_validate_Form);			
		...
		UseCaseFacade.changeStateOfPersonalFromEditionToValidating(usercode, personal.getCode());
