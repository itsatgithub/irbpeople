package presentation.actions.oPositionSys;
...
import presentation.formbeans.objects.*;
	...
	import presentation.formbeans.oPositionSys.*;
 ...
 *
 */
public class Action_modify_page_position extends Action {
...
Action_modify_page_position_Form action_modify_page_position_Form=(Action_modify_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_page_position_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Position position = UseCaseFacade.ObtainPosition(usercode, action_modify_page_position_Form.getPositioncode());
...
fbManager=new FormBeanManager(request, Action_modify_page_position_Form.class);
	...
	fbManager.setAttribute(position, "position_Form", Position_Form.class, action_modify_page_position_Form.getPosition_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPositionSys__action_modify_page_position_Form", fbManager.getContainer());
