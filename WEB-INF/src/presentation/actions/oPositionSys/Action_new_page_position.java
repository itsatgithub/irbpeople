 ...
 *
 */
public class Action_new_page_position extends Action {
...
Action_new_page_position_Form action_new_page_position_Form=(Action_new_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_position_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_position_Form.class);
	...
	fbManager.setAttribute(position, "position_Form", Position_Form.class, action_new_page_position_Form.getPosition_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPositionSys__action_new_page_position_Form", fbManager.getContainer());
