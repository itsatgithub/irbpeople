 ...
 *
 */
public class Action_modify_modify_page_position extends Action {
...
Action_modify_modify_page_position_Form action_modify_modify_page_position_Form=(Action_modify_modify_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_position_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Position position = UseCaseFacade.UpdatePosition(usercode,(Position) fbManager.getPOJO("position_Form",Position.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "positioncode="+position.getPositioncode(), isPopUp, position.getCode(), position.toString());
