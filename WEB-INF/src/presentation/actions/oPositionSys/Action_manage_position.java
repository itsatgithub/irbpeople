 ...
 *
 */
public class Action_manage_position extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Position>> _list_position=UseCaseFacade.ObtainAllPosition(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Position_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_position.getSecond(), locale, Position_Form.class);
