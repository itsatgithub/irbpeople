 ...
 *
 */
public class Action_delete_page_position extends Action {
...
Action_delete_page_position_Form action_delete_page_position_Form=(Action_delete_page_position_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_position_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Position position = UseCaseFacade.ObtainPosition(usercode, action_delete_page_position_Form.getPositioncode());
...
fbManager=new FormBeanManager(request, Action_delete_page_position_Form.class);
	...
	fbManager.setAttribute(position, "position_Form", Position_Form.class, action_delete_page_position_Form.getPosition_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oPositionSys__action_delete_page_position_Form", fbManager.getContainer());
