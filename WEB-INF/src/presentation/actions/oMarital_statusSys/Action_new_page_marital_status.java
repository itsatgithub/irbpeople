 ...
 *
 */
public class Action_new_page_marital_status extends Action {
...
Action_new_page_marital_status_Form action_new_page_marital_status_Form=(Action_new_page_marital_status_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_page_marital_status_Form);
...
fbManager=new FormBeanManager(request, Action_new_page_marital_status_Form.class);
	...
	fbManager.setAttribute(marital_status, "marital_status_Form", Marital_status_Form.class, action_new_page_marital_status_Form.getMarital_status_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oMarital_statusSys__action_new_page_marital_status_Form", fbManager.getContainer());
