 ...
 *
 */
public class Action_modify_modify_page_irb_budget extends Action {
...
Action_modify_modify_page_irb_budget_Form action_modify_modify_page_irb_budget_Form=(Action_modify_modify_page_irb_budget_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_irb_budget_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Irb_budget irb_budget = UseCaseFacade.UpdateIrb_budget(usercode,(Irb_budget) fbManager.getPOJO("irb_budget_Form",Irb_budget.class));	
	UseCaseFacade.updateIrb_budgetCode(usercode, irb_budget.getCode(), action_modify_modify_page_irb_budget_Form.getIrb_budget_Form().getNewIrb_budgetcode());
