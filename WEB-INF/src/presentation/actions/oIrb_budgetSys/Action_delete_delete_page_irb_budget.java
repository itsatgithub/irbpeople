 ...
 *
 */
public class Action_delete_delete_page_irb_budget extends Action {
...
Action_delete_delete_page_irb_budget_Form action_delete_delete_page_irb_budget_Form=(Action_delete_delete_page_irb_budget_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_delete_page_irb_budget_Form);			

	/** 3.  We use the business logic to remove the new item */
	
	UseCaseFacade.RemoveIrb_budget(usercode,action_delete_delete_page_irb_budget_Form.getIrb_budgetcode());	
