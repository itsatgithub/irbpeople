 ...
 *
 */
public class Action_new_new_page_gender extends Action {
...
Action_new_new_page_gender_Form action_new_new_page_gender_Form=(Action_new_new_page_gender_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_new_new_page_gender_Form);	
	
	/** 3.  We use the business logic to create the new item */
	
	Gender gender = UseCaseFacade.CreateGender(usercode,(Gender) fbManager.getPOJO("gender_Form",Gender.class));	
