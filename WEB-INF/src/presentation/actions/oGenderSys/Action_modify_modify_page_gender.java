 ...
 *
 */
public class Action_modify_modify_page_gender extends Action {
...
Action_modify_modify_page_gender_Form action_modify_modify_page_gender_Form=(Action_modify_modify_page_gender_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_gender_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Gender gender = UseCaseFacade.UpdateGender(usercode,(Gender) fbManager.getPOJO("gender_Form",Gender.class));	
...
return NavigationFunctions.findForward(request, mapping, "success", "gendercode="+gender.getGendercode(), isPopUp, gender.getCode(), gender.toString());
