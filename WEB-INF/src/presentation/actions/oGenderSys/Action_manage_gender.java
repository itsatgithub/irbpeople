 ...
 *
 */
public class Action_manage_gender extends Action {
	...
	/** 3.2.2.  We obtain the list of objects form the Business logic */
		...
		Pair<Integer,List<Gender>> _list_gender=UseCaseFacade.ObtainAllGender(usercode,filter.obtainListConfigurator(locale, false));
	
	/** 3.2.3.  We obtain copy the list of pojos to a list of FormBeans */
	
	List<Gender_Form> viewlistElements =ExtendedBeanUtils.copyPropertiesToFormBean(_list_gender.getSecond(), locale, Gender_Form.class);
