 ...
 *
 */
public class Action_delete_page_gender extends Action {
...
Action_delete_page_gender_Form action_delete_page_gender_Form=(Action_delete_page_gender_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_delete_page_gender_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Gender gender = UseCaseFacade.ObtainGender(usercode, action_delete_page_gender_Form.getGendercode());
...
fbManager=new FormBeanManager(request, Action_delete_page_gender_Form.class);
	...
	fbManager.setAttribute(gender, "gender_Form", Gender_Form.class, action_delete_page_gender_Form.getGender_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oGenderSys__action_delete_page_gender_Form", fbManager.getContainer());
