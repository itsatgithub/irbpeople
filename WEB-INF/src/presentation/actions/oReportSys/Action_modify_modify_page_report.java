 ...
 *
 */
public class Action_modify_modify_page_report extends Action {
...
Action_modify_modify_page_report_Form action_modify_modify_page_report_Form=(Action_modify_modify_page_report_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_modify_modify_page_report_Form);			
		
	/** 3.  We use the business logic to modify the new item */
	
	Report report = UseCaseFacade.UpdateReport(usercode,(Report) fbManager.getPOJO("report_Form",Report.class));	
