 ...
 *
 */
public class Action_view_alumni_external_job_sectors extends Action {
...
Action_view_alumni_external_job_sectors_Form action_view_alumni_external_job_sectors_Form=(Action_view_alumni_external_job_sectors_Form) form;

FormBeanManager fbManager=new FormBeanManager(request, action_view_alumni_external_job_sectors_Form);
	
	/** 4.  We obtain the initial POJO. */
	
	Alumni_external_job_sectors alumni_external_job_sectors = UseCaseFacade.ObtainAlumni_external_job_sectors(usercode, action_view_alumni_external_job_sectors_Form.getAlumni_external_job_sectorscode());
...
fbManager=new FormBeanManager(request, Action_view_alumni_external_job_sectors_Form.class);
	...
	fbManager.setAttribute(alumni_external_job_sectors, "alumni_external_job_sectors_Form", Alumni_external_job_sectors_Form.class, action_view_alumni_external_job_sectors_Form.getAlumni_external_job_sectors_Form());
	
	/** 6.3.  We add the container of the manager to the request. */
	
	request.setAttribute("oAlumni_external_job_sectorsSys__action_view_alumni_external_job_sectors_Form", fbManager.getContainer());
