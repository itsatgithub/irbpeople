/**
 * $Header: d:/repository/cvs/cc-adapter-struts-1.2/adapter/com/cc/framework/adapter/struts/ssl/FWSecureRequestProcessor.java,v 1.1 2005/04/04 16:05:11 P001002 Exp $
 * $Revision: 1.1 $
...
import org.apache.struts.action.SecureRequestProcessor;
...
/**
 * HTTPS Secured RequestProcessor
 * 
 * @author		<a href="mailto:hschulz@scc-gmbh.com">Harald Schulz</a>
 * @version		$Revision: 1.1 $
 */
public class FWSecureRequestProcessor extends SecureRequestProcessor {

	/**
	 * Constructor
	 */
	public FWSecureRequestProcessor() {
		super();
	}
	...
	protected void processForwardConfig(
		...
		if (forward.getRedirect()) {
			response.sendRedirect(
				RequestProcessorUtil.getForwardURL(
