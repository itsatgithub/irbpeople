 ...
 */
public abstract class DefFramePainterBase extends ControlPortionPainter implements FramePainter {
		...
		if (!showButtons(title)) {
			...
			if (title.hasButtons()) {
				...
				while (iter.hasNext()) {
                    ...
                    //
                    //
                    ConcreteElement input = SchedulerFacadeForCommonControlsScheduler.insideTagHrefToInputHTMLTagTransformer(button);
                    //
                    //
                    //
					...
					if (button != null) {
                        ...
                        // New.
                        container.addElement(new TD(input));
					}
				}
			}
