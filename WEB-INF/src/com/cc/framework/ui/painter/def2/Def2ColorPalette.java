/**
 * $Header: d:/repository/cvs/cc-framework/painter/com/cc/framework/ui/painter/def2/Def2ColorPalette.java,v 1.101 2005/11/13 14:03:58 P001002 Exp $
 * $Revision: 1.101 $
 ...
 */
public class Def2ColorPalette implements ColorPalette, Serializable {
	...
	public static final String BUTTON_COLOR_BORDER_INACTIVE = "button.color.border.inactive";

	/** Pattern activ (State id = 1) */
	public static final String BUTTON_COLOR_PATTERN_ACTIVE = "button.color.pattern.active";

	/** Pattern down (State id = 4) */
	public static final String BUTTON_COLOR_PATTERN_DOWN = "button.color.pattern.down";

	/** Pattern hover (State id = 3) */
	public static final String BUTTON_COLOR_PATTERN_HOVER = "button.color.pattern.hover";

	/** Pattern inactiv (State id = 2) */
	public static final String BUTTON_COLOR_PATTERN_INACTIVE = "button.color.pattern.inactive";
	...
	static {
		...
		Color colE7EEF3 = new Color(15199987);
		...
		Color colF8FAFB = new Color(16317179);
		...
		PALETTE.put(BUTTON_COLOR_BORDER, col004882);
		PALETTE.put(BUTTON_COLOR_BORDER_INACTIVE, col9CB9D0);
		PALETTE.put(BUTTON_COLOR_PATTERN_ACTIVE, colC2E2FF);
		PALETTE.put(BUTTON_COLOR_PATTERN_DOWN, col004882);
		PALETTE.put(BUTTON_COLOR_PATTERN_HOVER, col004882);
		PALETTE.put(BUTTON_COLOR_PATTERN_INACTIVE, col004882);
		PALETTE.put(BUTTON_COLOR_STATE_ACTIVE, col004882);
		PALETTE.put(BUTTON_COLOR_STATE_DOWN, col789DBA);
		PALETTE.put(BUTTON_COLOR_STATE_HOVER, colFEA217);
		PALETTE.put(BUTTON_COLOR_STATE_INACTIVE, colF8FAFB);
		PALETTE.put(BUTTON_COLOR_TEXT_ACTIVE, col004882);
		PALETTE.put(BUTTON_COLOR_TEXT_INACTIVE, col9CB9D0);
		...
		PALETTE.put(FORM_COLOR_BG, colCFE1EB);
		PALETTE.put(FORM_COLOR_BG_FIELD, colEFEFEF);
		PALETTE.put(FORM_COLOR_BG_HEADER, col1E5C99);
		PALETTE.put(FORM_COLOR_BG_IF, colFFFFFF);
		PALETTE.put(FORM_COLOR_BG_LABEL, colCFE1EB);
		PALETTE.put(FORM_COLOR_BG_SECTION, col9CB9D0);
		PALETTE.put(FORM_COLOR_BORDER, col1E5C99);
		PALETTE.put(FORM_COLOR_BORDER_ITEM, colBDBDBD);
		PALETTE.put(FORM_COLOR_BORDER_SECTION, col1E5C99);
		...
		PALETTE.put(FORM_COLOR_TEXT_SECTION, col1E5C99);
		PALETTE.put(FRAME_COLOR_BG, colCFE1EB);
		PALETTE.put(FRAME_COLOR_BG_HEADER, col1E5C99);
		PALETTE.put(FRAME_COLOR_BG_IF, colFFFFFF);
		PALETTE.put(FRAME_COLOR_BORDER, col1E5C99);
		...
		PALETTE.put(HEAD_COLOR_BG, colCFE1EB);
		PALETTE.put(HEAD_COLOR_BORDER, col1E5C99);
		PALETTE.put(HEAD_COLOR_SEPARATOR, colFFFFFF);
		PALETTE.put(HEADER_COLOR_BORDER, col6384BD);
		PALETTE.put(HEADER_COLOR_TEXT_CAPTION, colF57E17);
		PALETTE.put(HEADER_COLOR_TEXT_DETAIL, col6384BD);
		...
		PALETTE.put(INFO_COLOR_TEXT, col1E5C99);
		PALETTE.put(LIST_COLOR_BG_INPUT, colFFFFFF);
		PALETTE.put(LIST_COLOR_BG_BODY, colCFE1EB);
		PALETTE.put(LIST_COLOR_BG_COLHEADER, col6384BD);
		PALETTE.put(LIST_COLOR_BG_COLHEADER1, col6384BD);
		PALETTE.put(LIST_COLOR_BG_COLHEADER2, col6384BD);
		PALETTE.put(LIST_COLOR_BG_EVEN, colEDEFF0);
		PALETTE.put(LIST_COLOR_BG_EVENS, colFFCC99);
		PALETTE.put(LIST_COLOR_BG_HEADER, col1E5C99);
		...
		PALETTE.put(LIST_COLOR_BORDER_INPUT, col1E5C99);
		PALETTE.put(LIST_COLOR_BORDER_BODY, col1E5C99);
		PALETTE.put(LIST_COLOR_BORDER_IF, col1E5C99);
		...
		PALETTE.put(PANEL_COLOR_BG_BODY, colE7EEF3);
		PALETTE.put(PANEL_COLOR_BG_HEADER, colB8CBE1);
		PALETTE.put(PANEL_COLOR_BORDER_BODY, colE7EEF3);
		PALETTE.put(PANEL_COLOR_BORDER_HEADER, colFFFFFF);
		PALETTE.put(PANEL_COLOR_ITEM_BORDER, col808080);
		PALETTE.put(PANEL_COLOR_TEXT_HEADER, col004882);
		PALETTE.put(SCHEDULER_COLOR_BG_APP, colCECECE);
		PALETTE.put(SCHEDULER_COLOR_BG_BODY, colCFE1EB);
		PALETTE.put(SCHEDULER_COLOR_BG_DAYS, col6384BD);
		PALETTE.put(SCHEDULER_COLOR_BG_HEADER, col1E5C99);
		PALETTE.put(SCHEDULER_COLOR_BG_IF, colFFFFFF);
		PALETTE.put(SCHEDULER_COLOR_BG_NAV, col1E5C99);
		PALETTE.put(SCHEDULER_COLOR_BG_OVERFLOW, col808080);
		PALETTE.put(SCHEDULER_COLOR_BORDER_APP, col000000);
		PALETTE.put(SCHEDULER_COLOR_BORDER_BODY, col1E5C99);
		PALETTE.put(SCHEDULER_COLOR_BORDER_DAYS, col1E5C99);
		PALETTE.put(SCHEDULER_COLOR_BORDER_IF, col1E5C99);
		PALETTE.put(SCHEDULER_COLOR_BORDER_TODAY, colFEA217);
		PALETTE.put(SCHEDULER_COLOR_DAYVIEW_BG, col1E5C99);
		...
		PALETTE.put(SCHEDULER_COLOR_WEEKVIEW_BORDER, col1E5C99);
		...
		PALETTE.put(SELECTION_COLOR_BG, colFEA217);
		...
		PALETTE.put(TABBAR_COLOR_BG_LEVEL2, colCFE1EB);
		PALETTE.put(TABBAR_COLOR_BG_LEVEL3, colC4C8C9);
		PALETTE.put(TABBAR_COLOR_BORDER, col1E5C99);
		...
		PALETTE.put(TABSET_COLOR_BG_LEVEL2, colCFE1EB);
		PALETTE.put(TABSET_COLOR_BG_LEVEL3, colC4C8C9);
		PALETTE.put(TABSET_COLOR_BORDER, col1E5C99);
		...
		PALETTE.put(VMENU1_COLOR_BG, col9CB9D0);
		PALETTE.put(VMENU1_COLOR_BG_DISABLED, col9CB9D0);
		PALETTE.put(VMENU1_COLOR_BG_SEL, col9CB9D0);
		PALETTE.put(VMENU1_COLOR_BORDER, colFFFFFF);
		PALETTE.put(VMENU1_COLOR_TEXT_A, col1E5C99);
		PALETTE.put(VMENU1_COLOR_TEXT_A_SEL, col1E5C99);
		PALETTE.put(VMENU1_COLOR_TEXT_DISABLED, colCCDAEA);
		PALETTE.put(VMENU2_COLOR_BG, colCCDAEA);
		PALETTE.put(VMENU2_COLOR_BG_DISABLED, colCCDAEA);
		PALETTE.put(VMENU2_COLOR_BG_SEL, colFEA217);
		PALETTE.put(VMENU2_COLOR_BORDER, colFFFFFF);
		PALETTE.put(VMENU2_COLOR_TEXT, col1E5C99);
		PALETTE.put(VMENU2_COLOR_TEXT_A, col1E5C99);
