...
ADD COLUMN `remarks`  varchar(2550) NULL AFTER `show_data`,
ADD COLUMN `skype`  varchar(100) NULL DEFAULT NULL AFTER `remarks`,
ADD COLUMN `cellphone`  varchar(20) NULL DEFAULT NULL AFTER `skype`,
ADD COLUMN `deceased`  tinyint(4) NULL DEFAULT 0 AFTER `cellphone`,
ADD COLUMN `communications_wanted`  tinyint(4) NULL DEFAULT 0 AFTER `deceased`;


ALTER VIEW `view_alumni_personnel` AS 
SELECT 
